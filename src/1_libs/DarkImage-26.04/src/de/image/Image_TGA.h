...
struct TGAHeader
{
    ...
    uint32_t getBytesPerPixel() const { return uint32_t( bitsPerPixel ) / 8; }
...
#endif // defined(DE_IMAGE_READER_TGA_ENABLED) || defined(DE_IMAGE_WRITER_TGA_ENABLED)
...
#if defined(DE_IMAGE_WRITER_TGA_ENABLED)
