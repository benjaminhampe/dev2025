...
#include <juce_video/native/juce_win32_ComTypes.h>
...
private:
    ...
    private:
        ...
        struct NativeWindowClass   : private DeletedAtShutdown
        {
            ...
            LPCWSTR getWindowClassName() const noexcept { return (LPCWSTR)(pointer_sized_uint) MAKELONG (atom, 0); }
        ...
        struct NativeWindow
        {
            NativeWindow (HWND parentToAddTo, void* userData)
            {
                ...
                if (wc->isRegistered())
                {
                    ...
                    hwnd = CreateWindowExW(exstyle, wc->getWindowClassName(),
