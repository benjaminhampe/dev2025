...
namespace gui
{
    ...
    {
      return getFont("../../media/fonts/nel19.ttf", 0);
    ...
    {
      return getFont("../../media/fonts/Lobster/Lobster-Regular.ttf", 0);
    ...
    {
      return getFont("../../media/fonts/Ms_Madi/MsMadi-Regular.ttf", 0);
