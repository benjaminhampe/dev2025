...
void EnvelopeCurve::paint (Graphics& g)
{
   ...
   grid.addLineSegment(Line<float>(0.f, float(getHeight()/2), width, float(getHeight() / 2)), 1.f);
   grid.addLineSegment(Line<float>(float(width/2), 0, float(width/2), float(getHeight())), 1.f);
   grid.addLineSegment(Line<float>(float(width/4), 0, float(width/4), float(getHeight())), 1.f);
   grid.addLineSegment(Line<float>(float(width*3/4),0,float(width*3/4), float(getHeight())), 1.f);
