...
TextEditor::GlobalMouseListener::GlobalMouseListener (Component& e)
   : editor (e)
{
   Desktop::getInstance().addGlobalMouseListener    (this);
}
TextEditor::GlobalMouseListener::~GlobalMouseListener()
{
   Desktop::getInstance().removeGlobalMouseListener (this);
}

bool
TextEditor::GlobalMouseListener::lastMouseDownInEditor() const
{
   return mouseDownInEditor;
}

void
TextEditor::GlobalMouseListener::mouseDown (const MouseEvent& event)
{
   mouseDownInEditor = event.originalComponent == &editor;
}
