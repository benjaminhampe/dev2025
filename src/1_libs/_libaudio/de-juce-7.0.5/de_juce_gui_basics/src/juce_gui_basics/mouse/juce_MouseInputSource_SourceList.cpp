...
#include <juce_gui_basics/mouse/juce_MouseInputSourceInternal.h>

namespace juce
{

// implemented in win32_Windowing.cpp
//bool addSource();
//bool canUseTouch();
...
MouseInputSource*
MouseInputSource::SourceList::addSource (int index, MouseInputSource::InputSourceType type)
{
...
MouseInputSource*
MouseInputSource::SourceList::getMouseSource (int index) noexcept
{
...
MouseInputSource*
MouseInputSource::SourceList::getOrCreateMouseInputSource
(
...
int
MouseInputSource::SourceList::getNumDraggingMouseSources() const noexcept
{
  int num = 0;
...
MouseInputSource*
MouseInputSource::SourceList::getDraggingMouseSource (int index) noexcept
{
  int num = 0;
...
void
MouseInputSource::SourceList::beginDragAutoRepeat (int interval)
{
  if (interval > 0)
  {
...
void
MouseInputSource::SourceList::timerCallback()
{
