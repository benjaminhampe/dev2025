...
//#include <juce_gui_basics/native/accessibility/juce_win32_UIAProviders.h>



//#include "juce_win32_AccessibilityElement.cpp"
...
String AccessibilityHandler::getTitle() const                  { return component.getTitle(); }

String AccessibilityHandler::getDescription() const            { return component.getDescription(); }

String AccessibilityHandler::getHelp() const                   { return component.getHelpText(); }
