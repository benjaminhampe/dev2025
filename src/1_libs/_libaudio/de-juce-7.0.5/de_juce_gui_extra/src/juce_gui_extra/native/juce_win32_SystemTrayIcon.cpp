/*
  ...
  ==============================================================================
*/
#include <juce_gui_extra/native/juce_win32_SystemTrayIcon.h>
...
//===============================================================================================
SystemTrayIconComponent::Pimpl::Pimpl (SystemTrayIconComponent& owner_, HICON hicon, HWND hwnd)
//===============================================================================================
  : owner(owner_),
    ...
    taskbarCreatedMessage(RegisterWindowMessageW(L"TaskbarCreated"))
{
  ...
  ChangeWindowMessageFilterType changeWindowMessageFilter
   = reinterpret_cast<ChangeWindowMessageFilterType>(getUser32Function ("ChangeWindowMessageFilter"));
...
void
SystemTrayIconComponent::Pimpl::updateIcon (HICON hicon)
{
...
void
SystemTrayIconComponent::Pimpl::setToolTip (const String& toolTip)
{
...
void
SystemTrayIconComponent::Pimpl::handleTaskBarEvent (const LPARAM lParam)
{
...
SystemTrayIconComponent::Pimpl::getPimpl (HWND hwnd)
{
...
//static
LRESULT CALLBACK
SystemTrayIconComponent::Pimpl::hookedWndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
LRESULT
SystemTrayIconComponent::Pimpl::windowProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void
SystemTrayIconComponent::Pimpl::showBubble (const String& title, const String& content)
{
...
void
SystemTrayIconComponent::Pimpl::notify (DWORD message) noexcept
{
   Shell_NotifyIconW(message, &iconData);
}
