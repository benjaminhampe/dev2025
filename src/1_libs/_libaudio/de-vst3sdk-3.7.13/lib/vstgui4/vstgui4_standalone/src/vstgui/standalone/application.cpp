...
{
    vstgui_assert(delegate.get() != nullptr);//, "Delegate cannot be nullptr");
	return *(delegate.get ());
}
...
{
    vstgui_assert(inConfig.window != nullptr);
