...
inline float nvg__sqrtf(float a) { return sqrtf(a); }
inline float nvg__modf(float a, float b) { return fmodf(a, b); }
inline float nvg__sinf(float a) { return sinf(a); }
inline float nvg__cosf(float a) { return cosf(a); }
inline float nvg__tanf(float a) { return tanf(a); }
inline float nvg__atan2f(float a,float b) { return atan2f(a, b); }
inline float nvg__acosf(float a) { return acosf(a); }

inline int nvg__mini(int a, int b) { return a < b ? a : b; }
inline int nvg__maxi(int a, int b) { return a > b ? a : b; }
inline int nvg__clampi(int a, int mn, int mx) { return a < mn ? mn : (a > mx ? mx : a); }
inline float nvg__minf(float a, float b) { return a < b ? a : b; }
inline float nvg__maxf(float a, float b) { return a > b ? a : b; }
inline float nvg__absf(float a) { return a >= 0.0f ? a : -a; }
inline float nvg__signf(float a) { return a >= 0.0f ? 1.0f : -1.0f; }
inline float nvg__clampf(float a, float mn, float mx) { return a < mn ? mn : (a > mx ? mx : a); }
inline float nvg__cross(float dx0, float dy0, float dx1, float dy1) { return dx1*dy0 - dx0*dy1; }

inline float nvg__normalize(float *x, float* y)
{
...
void nvg__chooseBevel(int bevel, NVGpoint* p0, NVGpoint* p1, float w,
...
NVGvertex* nvg__roundJoin(NVGvertex* dst, NVGpoint* p0, NVGpoint* p1,
...
NVGvertex* nvg__bevelJoin(NVGvertex* dst, NVGpoint* p0, NVGpoint* p1,
...
NVGvertex* nvg__buttCapStart(NVGvertex* dst, NVGpoint* p,
...
NVGvertex* nvg__buttCapEnd(NVGvertex* dst, NVGpoint* p,
								  float dx, float dy, float w, float d,
								  float aa, float u0, float u1)
{
	float px = p->x + dx*d;
...
NVGvertex* nvg__roundCapStart(NVGvertex* dst, NVGpoint* p,
...
NVGvertex* nvg__roundCapEnd(NVGvertex* dst, NVGpoint* p,
								   float dx, float dy, float w, int ncap,
								   float aa, float u0, float u1)
{
	int i;
