   ...
   */
   ...
   public:
      ...
      */
      ...
      //! Sets the icon of the window by a resource id
      //! The resource id is located inside a .rc resource file.
      //! The resource file is compiled with win32-res compiler
      //! Probably only on Windows and Linux+WINE
      virtual void setWindowIcon( int resourceID ) {}
