...
bool CD3D9Texture::createTexture(u32 flags, IImage * image)
{
   ...
   {
   case ETCF_ALWAYS_16_BIT: format = D3DFMT_A1R5G5B5; break;
   case ETCF_ALWAYS_32_BIT: format = D3DFMT_A8R8G8B8; break;
   case ETCF_OPTIMIZED_FOR_QUALITY:
      {
         switch(image->getColorFormat())
         {
         case ECF_R8G8B8: format = D3DFMT_A8R8G8B8; break;
         case ECF_A8R8G8B8: format = D3DFMT_A8R8G8B8; break;
         case ECF_A1R5G5B5: format = D3DFMT_A1R5G5B5; break;
         case ECF_R5G6B5: format = D3DFMT_A1R5G5B5; break;
         default: break;
         }
      }
      break;
   case ETCF_OPTIMIZED_FOR_SPEED: format = D3DFMT_A1R5G5B5; break;
   default:	break;
   }
...
bool CD3D9Texture::isRenderTarget() const { return IsRenderTarget; }
...
void CD3D9Texture::setPitch(D3DFORMAT d3dformat)
{
   switch(d3dformat)
   {
   case D3DFMT_X1R5G5B5: Pitch = TextureSize.Width * 2; break;
   case D3DFMT_A1R5G5B5: Pitch = TextureSize.Width * 2; break;
   case D3DFMT_A8B8G8R8: Pitch = TextureSize.Width * 4; break;
   case D3DFMT_A8R8G8B8: Pitch = TextureSize.Width * 4; break;
   case D3DFMT_X8R8G8B8: Pitch = TextureSize.Width * 4; break;
   case D3DFMT_R5G6B5:   Pitch = TextureSize.Width * 2; break;
   case D3DFMT_R8G8B8:   Pitch = TextureSize.Width * 3; break;
