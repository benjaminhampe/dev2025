...
public:
   void addCube( SMeshBuffer & o
      ...
      , bool flip = false
      , core::vector2df const & texScale = core::vector2df(1,1)
   ) const;

   void addCube( SMeshBuffer & o
      , core::vector3df const & siz
      , core::vector3df const & pos = core::vector3df(0,0,0)
      , video::SColor const & color = 0xFFFFFFFF
      , bool flip = false
      , core::vector2df const & texScale = core::vector2df(1,1)
   ) const;
