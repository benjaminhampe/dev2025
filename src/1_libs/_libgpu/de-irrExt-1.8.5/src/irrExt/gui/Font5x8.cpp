...
Font5x8::Font5x8()
// ===========================================================================
   : quadWidth( 1 ), quadHeight( 1 )
   , quadSpacingX( 0 ), quadSpacingY( 0 )
   , glyphSpacingX( 1 ), glyphSpacingY( 1 )
{

}

Font5x8::Font5x8( int quadWidth_,
         int quadHeight_,
         int quadSpacingX_,
         int quadSpacingY_,
         int glyphSpacingX_,
         int glyphSpacingY_)
   : quadWidth(quadWidth_)
   , quadHeight(quadHeight_)
...
Font5x8Face::createGlyphCache( Font5x8Face::GlyphCache & cache )
{
   auto addGlyph = [&cache] (
      uint32_t unicode,
      std::string const & row0 = "",
      std::string const & row1 = "",
      std::string const & row2 = "",
      std::string const & row3 = "",
      std::string const & row4 = "",
      std::string const & row5 = "",
      std::string const & row6 = "",
      std::string const & row7 = "" )
   {
...
/*
void
Font5x8Face::drawText( Image & o, int x, int y, std::string const & msg, uint32_t color, Align align )
{
   ...
   {
      Font5x8::TextSize ts = getTextSize( msg ); // Optimize here for single lines, default: multiline but slower.
      float tw = ts.width;
      float th = ts.height;
