...
// ===========================================================================
{
    ...
    void
    draw2DDebug(Font const & font = Font());

    void
    draw2DText(int x, int y, std::string const & msg, uint32_t color = 0xFF000000,
               Align align = Align::Default, Font const & font = Font(),
               uint32_t bgColor = 0xFFFFFFFF, int padding = 10 );
    ...
    void
    draw2DTextDebug( int x, int y, std::wstring const & msg, uint32_t color = 0xFF000000,
               Align align = Align::Default, Font const & font = Font() );
