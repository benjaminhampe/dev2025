...
{
    LOG = 0,        //< A log event
    TIMER,          //< An event of the (underlying) native window.
    PAINT,          //< An event of the (underlying) native window.
    MOVE,           //< An event of the (underlying) native window.
    ...
    MOUSE_DBLCLICK, //< A mouse input event.
...
inline std::string
getEventTypeStr( EventType const eventType )
{
    switch ( eventType )
    {
    case EventType::LOG: return "LOG";
    case EventType::TIMER: return "TIMER";
    case EventType::PAINT: return "PAINT";
    ...
    case EventType::MOUSE_DBLCLICK: return "MOUSE_DBLCLICK";
    case EventType::JOYSTICK: return "JOYSTICK";
    case EventType::GUI: return "GUI";
...
{
    uint32_t id = 0;
    std::string str() const { return std::to_string(id); }
};
...
// ========================================================================
{
    ...
    {
        std::ostringstream o;
        o << "type(" << int(m_eventType) << "), caller(" << m_caller << ")";
        return o.str();
    }
};
...
// ========================================================================
{
    ...
    {
        std::ostringstream o;
        o << int(m_id) << "," << m_name << "," << m_buttons << "," << m_axes << "," << int(m_povHat);
        return o.str();
    }
};
...
// ========================================================================
{
    ...
    {
        std::stringstream o;
        o << userData << "," << userData1 << "," << userData2;
        return o.str();
    }
};
...
// ========================================================================
{
    ...
    std::string str() const
    {
        ...
        switch ( type )
        {
        case EventType::LOG: o << logEvent.str(); break;
        case EventType::TIMER: o << resizeEvent.str(); break;
        case EventType::PAINT: o << resizeEvent.str(); break;
        case EventType::MOVE: o << moveEvent.str(); break;
        case EventType::RESIZE: o << resizeEvent.str(); break;
        case EventType::SHOW: o << showEvent.str(); break;
        ...
        case EventType::MOUSE_MOVE: o << mouseMoveEvent.str(); break;
        case EventType::MOUSE_WHEEL: o << mouseWheelEvent.str(); break;
        case EventType::MOUSE_DBLCLICK: o << mouseDblClickEvent.str(); break;
        case EventType::JOYSTICK: o << joystickEvent.str(); break;
        case EventType::GUI: o << guiEvent.str(); break;
        case EventType::USER: o << userEvent.str(); break;
        default: break;
        }
        return o.str();
    }
    ...
    static void dump()
    {
        DE_DEBUG("sizeof(Event) = ",sizeof(Event))
    ...
    */
    ...
    ~Event() {}
    // Default ctr
    Event() : type(EventType::USER), userEvent() {}
    Event(TimerEvent event) : type(EventType::TIMER), timerEvent(event) {}
    Event(PaintEvent event) : type(EventType::PAINT), paintEvent(event) {}
    Event(MoveEvent event) : type(EventType::MOVE), moveEvent(event) {}
    Event(ResizeEvent event) : type(EventType::RESIZE), resizeEvent(event) {}
    Event(ShowEvent event) : type(EventType::SHOW), showEvent(event) {}
    ...
    Event(MouseReleaseEvent event) : type(EventType::MOUSE_RELEASE), mouseReleaseEvent(event) {}
    Event(MouseMoveEvent event) : type(EventType::MOUSE_MOVE), mouseMoveEvent(event) {}
    Event(MouseWheelEvent event) : type(EventType::MOUSE_WHEEL), mouseWheelEvent(event) {}
    Event(MouseDblClickEvent event) : type(EventType::MOUSE_DBLCLICK), mouseDblClickEvent(event) {}

    Event(LogEvent event) : type(EventType::LOG), logEvent(event) {}
    Event(GuiEvent event) : type(EventType::GUI), guiEvent(event) {}
    Event(UserEvent event) : type(EventType::USER), userEvent(event) {}
    Event(JoystickEvent event) : type(EventType::JOYSTICK), joystickEvent(event) {}
};
