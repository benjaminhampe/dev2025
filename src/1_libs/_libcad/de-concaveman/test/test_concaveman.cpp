...
static void test_00_rtree_basic() {
    ...
    for (auto i = 0; i < 500; i++) {
        auto a = static_cast<float>(rand() % 100);
        auto b = static_cast<float>(rand() % 100);
        auto c = static_cast<float>(rand() % 100);
        auto d = static_cast<float>(rand() % 100);
