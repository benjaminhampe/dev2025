#ifndef DE_BENNI_FONTAWESOME463_SYMBOL_ENUM_2104_HPP
#define DE_BENNI_FONTAWESOME463_SYMBOL_ENUM_2104_HPP

// Works for the fontawesome 463 font, the enums dont fit fa5.

/// A list of all icon-names with the codepoint ( as unicode-value -> QChar) on the right
...
namespace fb {
   enum eBenniIcon {
      ...
      Next = 0xf051,
      Eject = 0xf052,
      Calendar = 0xf073, // -> Timed AutoPlay Pilot
      Youtube2 = 0xf166,
      Youtube = 0xf167,
      Youtube3 = 0xf16a,
      ArchiveBox = 0xf187,
      ...
      Minimize = 0xf078,
      EMail = 0xf0e0,
      SmallArrowDown = 0xf0d7,
      SmallArrowUp = 0xf0d8,
      SmallArrowLeft = 0xf0d9,
      SmallArrowRight = 0xf0da,
      SplitWindow = 0xf0db,
      SmallArrowSplit = 0xf0dc,
      SmallArrowSplitUp = 0xf0dd,
      SmallArrowSplitDown = 0xf0de,
      SwitchOff = 0xf204,
      SwitchOn = 0xf205,
      Monitor = 0xf26c,
      UsbExtern = 0xf287,
...
#endif // DE_BENNI_LIKES_FONTAWESOME_CONSTANTS_AND_HELPERS_HPP
