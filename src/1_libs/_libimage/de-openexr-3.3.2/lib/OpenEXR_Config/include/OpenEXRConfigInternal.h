...
// clang-format off
#ifndef OPENEXR_IMF_HAVE_LINUX_PROCFS
...
// #ifndef OPENEXR_IMF_HAVE_DARWIN
...
#ifndef OPENEXR_IMF_HAVE_COMPLETE_IOMANIP
#define OPENEXR_IMF_HAVE_COMPLETE_IOMANIP 1
#endif
//
// Define if we can use sysconf(_SC_NPROCESSORS_ONLN) to get CPU count
//
#ifndef OPENEXR_IMF_HAVE_SYSCONF_NPROCESSORS_ONLN
#define OPENEXR_IMF_HAVE_SYSCONF_NPROCESSORS_ONLN 0
#endif
//
// Define if we can support GCC style inline asm with AVX instructions
//
#ifndef OPENEXR_IMF_HAVE_GCC_INLINE_ASM_AVX
...
// #ifndef OPENEXR_MISSING_ARM_VLD1
