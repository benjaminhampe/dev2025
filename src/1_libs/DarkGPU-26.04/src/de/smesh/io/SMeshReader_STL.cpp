...
//         {
         ...
         {
            auto a = p->getVertex( p->getIndex( j ) ).pos;
            auto b = p->getVertex( p->getIndex( j+1 ) ).pos;
            auto c = p->getVertex( p->getIndex( j+2 ) ).pos;
