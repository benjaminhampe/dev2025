...
// =====================================================================
PMeshSceneNode::PMeshSceneNode( SceneManager* env, ISceneNode* parent, u32 id, f32 x, f32 y, f32 z )
    : ISceneNode(env,parent,id,x,y,z)
{}

PMeshSceneNode::~PMeshSceneNode() {}


Box3f
PMeshSceneNode::getAbsoluteBoundingBox()
{
    auto m = getAbsoluteTransform();
    return m_mesh.m_bbox.transformBox(m);
}
// =====================================================================
void 			PMeshSceneNode::setMesh( PMesh mesh )
{
    m_mesh = mesh;
...
const PMesh& 	PMeshSceneNode::getMesh() const { return m_mesh; }
PMesh& 		 	PMeshSceneNode::getMesh() { return m_mesh; }
// =====================================================================
void PMeshSceneNode::draw()
{
