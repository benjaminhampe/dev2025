#include <de/gpu/renderer/FontRenderer5x8_NoDriver.h>
#include <de_opengl.h>

namespace de {
namespace gpu {
// ===========================================================================
FontRenderer5x8_NoDriver::FontRenderer5x8_NoDriver()
// ===========================================================================
    : m_shader(0)
    , m_vao(0)
    , m_vbo(0)
...
//FontRenderer5x8_NoDriver::~Font5x8Renderer(){}

void
FontRenderer5x8_NoDriver::init()
{
    if ( !m_shader )
    {
        std::string vs = R"(
        ...
        m_shaderId = GT_createShader( "FontRenderer5x8_NoDriver", vs, fs );

        m_screenWidthLoc = glGetUniformLocation( m_shaderId, "u_screenW");
        m_screenHeightLoc = glGetUniformLocation( m_shaderId, "u_screenH");
...
void
FontRenderer5x8_NoDriver::destroy()
{
    if ( m_vao )
    {
...
void
FontRenderer5x8_NoDriver::draw2DText( int x, int y, std::string const & msg, uint32_t color, Align align,
