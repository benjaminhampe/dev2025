...
/* ./.libs/lt-iconv_no_i18n.c - temporary wrapper executable for .libs/iconv_no_i18n
...
const char * LIB_PATH_VALUE   = "/home/firestarter/iconv-1.18/lib/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/firestarter/iconv-1.18/lib/.libs:";
const char * TARGET_PROGRAM_NAME = "iconv_no_i18n"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.5.4\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# iconv_no_i18n - temporary wrapper script for .libs/iconv_no_i18n\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The iconv_no_i18n program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.5.4'\n", f);
  fputs ("  notinst_deplibs=' ../lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"iconv_no_i18n:iconv_no_i18n:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"iconv_no_i18n:iconv_no_i18n:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"iconv_no_i18n:iconv_no_i18n:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("  done\n", f);
  fputs ("\n", f);
  fputs ("  # Usually 'no', except on cygwin/mingw/windows when embedded into\n", f);
  fputs ("  # the cwrapper.\n", f);
  ...
  fputs ("    PATH=/home/firestarter/iconv-1.18/lib/.libs:$PATH\n", f);
  fputs ("\n", f);
