...
/* minilzo/.libs/lt-testmini.c - temporary wrapper executable for .libs/testmini.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The minilzo/testmini program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "testmini.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2.418\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# minilzo/testmini - temporary wrapper script for .libs/testmini.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The minilzo/testmini program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.4.2.418'\n", f);
  ...
  fputs ("    echo \"testmini.exe:minilzo/testmini:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testmini.exe:minilzo/testmini:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testmini.exe:minilzo/testmini:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
