 ...
 */
int
__memp_fopen(DB_MPOOLFILE *dbmfp, MPOOLFILE *mfp, const char *path, const char **dirp, u_int32_t flags, int mode, size_t pgsize)
	// DB_MPOOLFILE *dbmfp;
	// MPOOLFILE *mfp;
	// const char *path;
	// const char **dirp;
		...
		if (!mfp->deadfile) {
			if (LF_ISSET(DB_MULTIVERSION)) {
				...
				if (MFP_OPEN_CNT(mfp) > 0 &&
					 db_atomic_read(&mfp->multiversion) == 0) {
 ...
 */
static int
__memp_mpf_find(ENV *env, DB_MPOOLFILE *dbmfp, DB_MPOOL_HASH *hp, const char *path, u_int32_t flags, MPOOLFILE **mfpp)
	// ENV *env;
	// DB_MPOOLFILE *dbmfp;
	// DB_MPOOL_HASH *hp;
	// const char *path;
...
static int
__memp_mpf_alloc(DB_MPOOL *dbmp, DB_MPOOLFILE *dbmfp, const char *path, u_int32_t pagesize, u_int32_t flags, MPOOLFILE **retmfp)
	// DB_MPOOL *dbmp;
	// DB_MPOOLFILE *dbmfp;
	// const char *path;
	// u_int32_t pagesize;
 ...
 */
int
__memp_fclose_pp(DB_MPOOLFILE *dbmfp, u_int32_t flags)
	// DB_MPOOLFILE *dbmfp;
	// u_int32_t flags;
{
	DB_THREAD_INFO *ip;
 ...
 */
int
__memp_fclose(DB_MPOOLFILE *dbmfp, u_int32_t flags)
	// DB_MPOOLFILE *dbmfp;
	// u_int32_t flags;
{
	DB_MPOOL *dbmp;
 ...
 */
int
__memp_mf_discard(DB_MPOOL *dbmp, MPOOLFILE *mfp, int hp_locked)
	// DB_MPOOL *dbmp;
	// MPOOLFILE *mfp;
	// int hp_locked;
{
 ...
 */
int
__memp_inmemlist(ENV *env, char ***namesp, int *cntp)
	// ENV *env;
	// char ***namesp;
	// int *cntp;
{
