 ...
 */
int
__bam_split_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
// ENV *env;
// DBT *dbtp;
// DB_LSN *lsnp;
// db_recops notused2;
 ...
 */
int
__bam_split_48_print( ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_split_42_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_rsplit_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_adj_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_cadjust_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_cdel_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_repl_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_irep_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_root_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_curadj_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_rcuradj_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_relink_43_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_merge_44_print(ENV *env, DBT *dbtp, DB_LSN *lsnp, db_recops notused2, void *info)
	// ENV *env;
	// DBT *dbtp;
	// DB_LSN *lsnp;
	// db_recops notused2;
 ...
 */
int
__bam_init_print(ENV *env, DB_DISTAB *dtabp)
	// ENV *env;
	// DB_DISTAB *dtabp;
{
	int ret;
