...
#include <signalsmith-plot/heatmap.h>
...
int main() {
    { // Basic example
        ...
        plot.write("signalsmith_plot_default-2d.svg");
    }
    ...
    { // Demonstrating default colour/dash/hatch/marker sequence
        ...
        figure.write("signalsmith_plot_style-sequence.svg");
    }
    ...
    { // Custom style, using a figure
        ...
        figure.write("signalsmith_plot_custom-2d.svg");
    }

    {
        ...
        figure.write("signalsmith_plot_custom-default-2d.svg");
    ...
    { // Line with multiple sections
        ...
        plot.write("signalsmith_plot_line-cut.svg");
    }
    ...
    { // Filled circles
        ...
        plot.write("signalsmith_plot_filled-circles.svg");
    }
    ...
    { // Multiple axes
        ...
        plot.write("signalsmith_plot_multiple-axes.svg");
    }
    ...
    { // Legend
        ...
        plot.write("signalsmith_plot_legend.svg", style);
    }
    ...
    { // Animation
        ...
        plot.write("signalsmith_plot_animation.svg");
    }
    ...
    { // Embedded image
        ...
        plot.image({-1, 1, 1, -1}, "media/signalsmith/square@2x.png");
        plot.write("signalsmith_plot_embedded-image.svg");
    }
    ...
    { // Embedded heat-map
        ...
        heatMap.write("signalsmith_plot_heat-map.png");

        plot.write("signalsmith_plot_embedded-heat-map.svg");
    }
    ...
    for (int i = 0; i < 2; ++i){ // Heat-map with automatically added scale
        ...
        figure.write("signalsmith_plot_embedded-heat-map-with-scale" + std::string(heatMap.light ? "-light" : "") + ".svg");
    }
    ...
    { // Scatter plot with varying radius
        ...
        figure.write("signalsmith_plot_scatter-plot.svg");
    }
    ...
    { // Animated scatter plot
        ...
        figure.write("signalsmith_plot_scatter-plot-animation.svg");
    }
}
