...
public:
		...
		: Sample( context )
	{
		...
		{
			m_levelMesh = CreateMeshData( "media/box3d_samples/data/meshes/test_map01.obj", 1.0f, false, false, true, true );
			b3BodyDef bodyDef = b3DefaultBodyDef();
			b3BodyId body = b3CreateBody( m_worldId, &bodyDef );
		...
		{
			m_stairs = CreateMeshData( "media/box3d_samples/data/meshes/stairs.obj", 1.0f, false, false, true, true );
...
public:
		...
		: Sample( context )
	{
		...
		{
			m_building = CreateMeshData( "media/box3d_samples/data/meshes/building.obj", 1.0f, false, false, true, true );
			b3BodyDef bodyDef = b3DefaultBodyDef();
		...
		{
			m_voxel01 = CreateMeshData( "media/box3d_samples/data/meshes/voxel_mesh_01.obj", 1.0f, false, false, true, true );
			b3BodyDef bodyDef = b3DefaultBodyDef();
		...
		{
			m_voxel02 = CreateMeshData( "media/box3d_samples/data/meshes/voxel_mesh_02.obj", 1.0f, false, false, true, true );
			b3BodyDef bodyDef = b3DefaultBodyDef();
			bodyDef.position = { 10.0f, 0.0f, 10.0f };
			b3BodyId body = b3CreateBody( m_worldId, &bodyDef );
