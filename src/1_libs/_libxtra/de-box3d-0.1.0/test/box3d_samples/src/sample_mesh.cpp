...
public:
		...
		: Sample( context )
	{
		...
		{
			m_buildingMesh = CreateMeshData( "media/box3d_samples/data/meshes/building.obj", 1.0f, false, false, true, true );
...
public:
	...
	void LoadMesh()
	{
		...
		char buffer[64] = {};
		snprintf( buffer, 64, "media/box3d_samples/data/meshes/%s", filesNames[m_meshIndex] );
...
public:
		...
		: Sample( context )
	{
		...
		LoadTempMesh( "media/box3d_samples/data/meshes/voxel_mesh_01.obj", m_tempMeshes + 0, 0.01f, true );
		LoadTempMesh( "media/box3d_samples/data/meshes/voxel_mesh_02.obj", m_tempMeshes + 1, 0.01f, true );
		LoadTempMesh( "media/box3d_samples/data/meshes/voxel_mesh_03.obj", m_tempMeshes + 2, 0.01f, true );
		LoadTempMesh( "media/box3d_samples/data/meshes/voxel_mesh_04.obj", m_tempMeshes + 3, 0.01f, true );
...
public:
		...
		: Sample( context )
	{
...

		{
			...
			float scale = 0.01f;
			TempMesh tempMesh;
			const char* fileName = "media/box3d_samples/data/meshes/collision_mesh_01.obj";
