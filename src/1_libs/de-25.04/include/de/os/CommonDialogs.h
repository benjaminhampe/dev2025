...
std::string dbOpenFolderDlg( BrowseFolderParamsA params );
...
std::string dbOpenFileDlg( OpenFileParamsA params );
...
struct OpenFileParamsW
{
    ...
    std::wstring filter = L"All Files (*.*)\0*.*\0\0";
...
std::wstring dbOpenFileDlg( OpenFileParamsW params );
...
std::string dbSaveFileDlg( SaveFileParamsA param );
...
std::wstring dbSaveFileDlg( SaveFileParamsW params );
