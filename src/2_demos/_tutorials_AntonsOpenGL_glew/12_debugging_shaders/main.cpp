...
#define VS_SHADER_FILE        "media/antons_opengl_book/12_debugging_shaders.vs"
#define FS_SHADER_FILE      "media/antons_opengl_book/12_debugging_shaders.fs"
#define TEXTURE_FILE_BOULDER_DIFF "media/antons_opengl_book/boulder_diff.png"
#define TEXTURE_FILE_BOULDER_SPEC "media/antons_opengl_book/boulder_spec.png"
#define TEXTURE_FILE_AO           "media/antons_opengl_book/ao.png"
#define TEXTURE_FILE_TILEABLE9B   "media/antons_opengl_book/tileable9b_emiss.png"
...
int main() {
	...
	GLuint shader_programme =
		create_programme_from_files( VS_SHADER_FILE, FS_SHADER_FILE );
	...
	*/
	...
	glActiveTexture( GL_TEXTURE0 );
	load_texture( TEXTURE_FILE_BOULDER_DIFF, &tex_diff );
	glActiveTexture( GL_TEXTURE1 );
	load_texture( TEXTURE_FILE_BOULDER_SPEC, &tex_spec );
	glActiveTexture( GL_TEXTURE2 );
	load_texture( TEXTURE_FILE_AO, &tex_amb );
	glActiveTexture( GL_TEXTURE3 );
	load_texture( TEXTURE_FILE_TILEABLE9B, &tex_emiss );
