...
#define TEXTURE_FILE    "media/antons_opengl_book/Droplet.png"
#define VS_SHADER_FILE  "media/antons_opengl_book/29_particle_systems.vs"
#define FS_SHADER_FILE  "media/antons_opengl_book/29_particle_systems.fs"
...
#define ONE_DEG_IN_RAD ( 2.0 * M_PI ) / 360.0 // 0.017444444
	...
	assert( P_loc > -1 );
	int emitter_pos_wor_loc =
		glGetUniformLocation( shader_programme, "emitter_pos_wor" );
	assert( emitter_pos_wor_loc > -1 );
	int elapsed_system_time_loc =
