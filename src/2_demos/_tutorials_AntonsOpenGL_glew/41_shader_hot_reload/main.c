...
#define TEST_VS "media/antons_opengl_book/41_shader_hot_reload.vs"
#define TEST_FS "media/antons_opengl_book/41_shader_hot_reload.fs"
...
int main() {
  ...
  shader_program = create_shader_program_from_files( TEST_VS, TEST_FS );
  if ( !shader_program ) {
    stop_opengl();
    return 1;
  }
