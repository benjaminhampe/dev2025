...
#define POST_VS     "media/antons_opengl_book/34_framebuffer_switch_post.vs"
#define POST_FS     "media/antons_opengl_book/34_framebuffer_switch_post.fs"
#define SPHERE_VS   "media/antons_opengl_book/34_framebuffer_switch_sphere.vs"
#define SPHERE_FS   "media/antons_opengl_book/34_framebuffer_switch_sphere.fs"
#define MESH_FILE   "media/antons_opengl_book/sphere.obj"
