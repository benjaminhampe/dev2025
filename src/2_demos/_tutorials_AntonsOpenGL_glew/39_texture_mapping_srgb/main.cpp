...
#define TEST_VS     "media/antons_opengl_book/39_texture_mapping_srgb.vs"
#define TEST_FS     "media/antons_opengl_book/39_texture_mapping_srgb.fs"
#define TEX0_FILE   "media/antons_opengl_book/skulluvmap.png"
...
bool load_texture( const char *file_name, GLuint *tex ) {
	...
	glTexImage2D( GL_TEXTURE_2D, 0, GL_SRGB_ALPHA, x, y, 0, GL_RGBA, GL_UNSIGNED_BYTE,
								image_data );
...
int main() {
	...
	GLuint shader_programme =
		create_programme_from_files( TEST_VS, TEST_FS );
