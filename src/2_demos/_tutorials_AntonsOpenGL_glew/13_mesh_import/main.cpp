...
#define VS_SHADER_FILE "media/antons_opengl_book/13_mesh_import.vs"
#define FS_SHADER_FILE "media/antons_opengl_book/13_mesh_import.fs"
#define MESH_FILE "media/antons_opengl_book/monkey2.obj"
