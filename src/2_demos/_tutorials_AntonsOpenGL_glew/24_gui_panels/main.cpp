...
#define TEXTURE_FILE2 "media/antons_opengl_book/tile2-diamonds256x256.png"
...
void create_ground_plane_shaders() {
	...
	const char *gp_vs_str =
		...
		"}";
	const char *gp_fs_str = "#version 410\n"
													"in vec2 st;"
...
void create_gui_shaders() {
	...
	const char *gui_vs_str = "#version 410\n"
													 "in vec2 vp;"
													 ...
													 "}";
	const char *gui_fs_str = "#version 410\n"
													 "in vec2 st;"
													 "uniform sampler2D tex;"
													 "out vec4 frag_colour;"
													 "void main () {"
...
/* We must specify 3.2 core if on Apple OS X -- other O/S can specify
 anything here. I defined 'APPLE' in the makefile for OS X */
	...
	float points[] = { -1.0f, -1.0f, 1.0f, -1.0f, -1.0f, 1.0f,
	...
	load_texture( TEXTURE_FILE, &gui_tex );
	load_texture( TEXTURE_FILE2, &gp_tex );
