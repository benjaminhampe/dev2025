...
#define VS_SHADER_FILE          "media/antons_opengl_book/30_skinning_part_one_test.vs"
#define FS_SHADER_FILE          "media/antons_opengl_book/30_skinning_part_one_test.fs"
#define VS_SHADER_BONES_FILE    "media/antons_opengl_book/30_skinning_part_one_bones.vs"
#define FS_SHADER_BONES_FILE    "media/antons_opengl_book/30_skinning_part_one_bones.fs"
#define MESH_FILE               "media/antons_opengl_book/monkey_with_bones_y_up.dae"
...
int main() {
	...
	GLuint bones_shader_programme =
		create_programme_from_files( VS_SHADER_BONES_FILE, FS_SHADER_BONES_FILE );
...
#define ONE_DEG_IN_RAD ( 2.0 * M_PI ) / 360.0 // 0.017444444
	...
	while ( !glfwWindowShouldClose( g_window ) ) {
		...
		if ( glfwGetKey( g_window, 'Z' ) ) {
			...
			glUseProgram( shader_programme );
			ear_mat = inverse( monkey_bone_offset_matrices[0] ) *
			...
			ear_mat = inverse( monkey_bone_offset_matrices[1] ) *
								rotate_z_deg( identity_mat4(), -theta ) *
								monkey_bone_offset_matrices[1];
