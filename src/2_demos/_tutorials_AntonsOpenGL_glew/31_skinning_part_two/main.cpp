...
#define VS_SHADER_FILE       "media/antons_opengl_book/31_skinning_part_two_test.vs"
#define FS_SHADER_FILE       "media/antons_opengl_book/31_skinning_part_two_test.fs"

#define VS_SHADER_BONES_FILE "media/antons_opengl_book/31_skinning_part_two_bones.vs"
#define FS_SHADER_BONES_FILE "media/antons_opengl_book/31_skinning_part_two_bones.fs"

#define MESH_FILE            "media/antons_opengl_book/monkey_with_skeleton_y_up.dae"
