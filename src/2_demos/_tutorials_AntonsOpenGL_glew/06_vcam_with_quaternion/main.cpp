...
#define VS_SHADER_FILE "media/antons_opengl_book/06_vcam_with_quaternion.vs"
#define FS_SHADER_FILE "media/antons_opengl_book/06_vcam_with_quaternion.fs"
...
int main() {
	...
	if ( NULL != vp ) {
		...
		glBufferData( GL_ARRAY_BUFFER, 3 * point_count * sizeof( GLfloat ), vp,
									GL_STATIC_DRAW );
