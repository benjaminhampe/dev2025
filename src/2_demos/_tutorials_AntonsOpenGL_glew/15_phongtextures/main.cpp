...
#define MESH_FILE                   "media/antons_opengl_book/monkey.obj"
#define VS_SHADER_FILE              "media/antons_opengl_book/15_phongtextures.vs"
#define FS_SHADER_FILE              "media/antons_opengl_book/15_phongtextures.fs"
