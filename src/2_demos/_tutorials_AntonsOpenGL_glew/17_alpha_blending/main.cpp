...
#define VS_SHADER_FILE  "media/antons_opengl_book/17_alpha_blending.vs"
#define FS_SHADER_FILE  "media/antons_opengl_book/17_alpha_blending.fs"
#define TEXTURE_FILE    "media/antons_opengl_book/blob.png"
#define TEXTURE_FILE2   "media/antons_opengl_book/blob2.png"
...
#define ONE_DEG_IN_RAD ( 2.0 * M_PI ) / 360.0 // 0.017444444
	...
	// load texture
	GLuint texa;
	load_texture( TEXTURE_FILE, &texa );
	GLuint texb;
	load_texture( TEXTURE_FILE2, &texb );
