...
#define PLAIN_VS    "media/antons_opengl_book/38_texture_shadows_plain.vs"
#define PLAIN_FS    "media/antons_opengl_book/38_texture_shadows_plain.fs"
#define DEBUG_VS    "media/antons_opengl_book/38_texture_shadows_ss_quad.vs"
#define DEBUG_FS    "media/antons_opengl_book/38_texture_shadows_ss_quad.fs"
#define DEPTH_VS    "media/antons_opengl_book/38_texture_shadows_depth.vs"
#define DEPTH_FS    "media/antons_opengl_book/38_texture_shadows_depth.fs"
...
void init_ground_plane() {
	GLuint points_vbo;
	GLfloat gp_pos[] = { -20.0, -1.0, -20.0, -20.0, -1.0, 20.0,	20.0,	-1.0, 20.0,
...
void init_spheres() {
	...
	if ( NULL != vp ) {
		glGenBuffers( 1, &points_vbo );
		glBindBuffer( GL_ARRAY_BUFFER, points_vbo );
		glBufferData( GL_ARRAY_BUFFER, 3 * g_sphere_point_count * sizeof( GLfloat ), vp,
									GL_STATIC_DRAW );
		glVertexAttribPointer( 0, 3, GL_FLOAT, GL_FALSE, 0, NULL );
		glEnableVertexAttribArray( 0 );
	}
...
void init_shadow_fb() {
	...
	glTexImage2D( GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, g_shadow_size, g_shadow_size,
