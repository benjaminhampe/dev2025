...
#define VS_SHADER_FILE "media/antons_opengl_book/23_tessellation_shaders.vs"
#define TESSCS_SHADER_FILE "media/antons_opengl_book/23_tessellation_shaders.tcs"
#define TESSEL_SHADER_FILE "media/antons_opengl_book/23_tessellation_shaders.tes"
#define FS_SHADER_FILE "media/antons_opengl_book/23_tessellation_shaders.fs"
...
/* We must specify 3.2 core if on Apple OS X -- other O/S can specify
 anything here. I defined 'APPLE' in the makefile for OS X */
	...
	GLfloat points[] = {
		...
		0.5f, -0.25f, 0.0f, 0.0f, -0.75f, 0.0f, -0.5f, -0.25f, 0.0f
	};
	...
	parse_file_into_str( VS_SHADER_FILE, vertex_shader, 4096 );
	parse_file_into_str( TESSCS_SHADER_FILE, tess_ctrl_shader, 4096 );
	parse_file_into_str( TESSEL_SHADER_FILE, tess_eval_shader, 4096 );
	parse_file_into_str( FS_SHADER_FILE, fragment_shader, 4096 );
	...
	int outer_tess_fac_loc =
		glGetUniformLocation( shader_programme, "tess_fac_outer" );
	int inner_tess_fac_loc =
		glGetUniformLocation( shader_programme, "tess_fac_inner" );
