...
#define VS_SHADER_FILE "media/antons_opengl_book/02_shaders.vs"
#define FS_SHADER_FILE "media/antons_opengl_book/02_shaders.fs"
...
int main() {
	...
	parse_file_into_str( VS_SHADER_FILE, vertex_shader, 1024 * 256 );
	parse_file_into_str( FS_SHADER_FILE, fragment_shader, 1024 * 256 );
