...
#define VS_SHADER_FILE "media/antons_opengl_book/07_ray_picking.vs"
#define FS_SHADER_FILE "media/antons_opengl_book/07_ray_picking.fs"
...
int main() {
  ...
  /*-------------------------------CREATE SHADERS-------------------------------*/
  GLuint shader_programme = create_programme_from_files( VS_SHADER_FILE, FS_SHADER_FILE );
