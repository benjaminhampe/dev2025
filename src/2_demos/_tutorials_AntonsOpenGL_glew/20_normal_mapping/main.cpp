...
#define NMAP_IMG_FILE   "media/antons_opengl_book/brickwork_normal-map.png"
#define MODEL_FILE      "media/antons_opengl_book/suzanne.obj"
#define VS_SHADER_FILE  "media/antons_opengl_book/20_normal_mapping.vs"
#define FS_SHADER_FILE  "media/antons_opengl_book/20_normal_mapping.fs"
...
bool load_mesh( const char *file_name ) {
	const aiScene *scene =
		aiImportFile( file_name, aiProcess_Triangulate | aiProcess_CalcTangentSpace );
	if ( !scene ) {
...
int main() {
	...
	if ( NULL != g_vtans ) {
		...
		glBufferData( GL_ARRAY_BUFFER, 4 * g_point_count * sizeof( GLfloat ), g_vtans,
									GL_STATIC_DRAW );
