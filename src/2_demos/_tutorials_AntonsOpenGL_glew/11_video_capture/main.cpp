...
#define TEXTURE_FILE   "media/antons_opengl_book/skulluvmap.png"
#define VS_SHADER_FILE "media/antons_opengl_book/11_video_capture.vs"
#define FS_SHADER_FILE "media/antons_opengl_book/11_video_capture.fs"
...
void grab_video_frame() {
	...
	glReadPixels( 0, 0, g_gl_width, g_gl_height, GL_RGB, GL_UNSIGNED_BYTE,
								g_video_memory_ptr );
...
bool dump_video_frame() {
	...
	unsigned char *last_row =
		g_video_memory_ptr + ( g_gl_width * 3 * ( g_gl_height - 1 ) );
