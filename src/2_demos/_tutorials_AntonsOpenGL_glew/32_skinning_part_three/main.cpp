...
#define VS_SHADER_FILE      "media/antons_opengl_book/32_skinning_part_three_test.vs"
#define FS_SHADER_FILE      "media/antons_opengl_book/32_skinning_part_three_test.fs"

#define VS_SHADER_BONES_FILE "media/antons_opengl_book/32_skinning_part_three_bones.vs"
#define FS_SHADER_BONES_FILE "media/antons_opengl_book/32_skinning_part_three_bones.fs"

#define MESH_FILE           "media/antons_opengl_book/monkey_with_anim_y_up.dae"
