...
int main()
{
   ...
   Shader shader("shader",
      loadString( "media/LearnOpenGL/4.5.2.framebuffers.vs"),
      loadString( "media/LearnOpenGL/4.5.2.framebuffers.fs") );

   Shader screenShader("screenShader",
      loadString( "media/LearnOpenGL/4.5.2.framebuffers_screen.vs"),
      loadString( "media/LearnOpenGL/4.5.2.framebuffers_screen.fs") );
