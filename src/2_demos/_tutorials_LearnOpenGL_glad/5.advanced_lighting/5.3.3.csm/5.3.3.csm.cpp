...
int main()
{
   ...
   Shader shader( "3.3.csm", 
      loadString( "media/LearnOpenGL/5.3.3.csm.vs" ), 
      loadString( "media/LearnOpenGL/5.3.3.csm.fs" ) );

   // Load textures
   GLuint cubeTexture = loadTexture( "media/LearnOpenGL/textures/marble.jpg" );
   GLuint floorTexture = loadTexture( "media/LearnOpenGL/textures/metal.png" );
