...
public:
   ...
   void HandleShortMidiEvent( amsynth_short_midi_event_t event );
   void sendNoteOn(u8 channel, u8 midiNote, u8 velocity);
   void sendNoteOff(u8 channel, u8 midiNote, u8 velocity);
