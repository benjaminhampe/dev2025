...
void ShowModalErrorMessage( std::string const& msg, std::string const& secondaryText)
{
   QMessageBox dlg;
   dlg.setText( QString::fromStdString(msg) );
   dlg.setInformativeText( QString::fromStdString(secondaryText) );
