...
{	
    ...
    computeRtxShader = new ComputeShader("media/Raytracing/shaders/ComputeRayTracing.comp");
...
{
    computePostProcShader = new ComputeShader("media/Raytracing/shaders/ComputePostProcessing.comp");
