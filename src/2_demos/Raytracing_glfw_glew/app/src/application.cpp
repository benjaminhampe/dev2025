...
int main() {
	...
	{	
        ...
        //BVH::BVH_data scene_BVH = BVH::construct("media/Raytracing/models/stanford_dragon_pbr.glb", active_heuristic);
        //BVH::BVH_data scene_BVH = BVH::construct("media/Raytracing/models/stanford_bunny_pbr.glb", active_heuristic);
        BVH::BVH_data scene_BVH = BVH::construct("media/Raytracing/thief_obj/thief.obj", active_heuristic);
		...
		while (!glfwWindowShouldClose(window)) {
            ...
            //std::cout <<
            //        "postProcOutput->ID64() = " << postProcOutput->ID64() << "|"
            //        "topLeftTextureCoords = " << topLeftTextureCoords.x << ", " << topLeftTextureCoords.y << "|"
            //        "bottomLeftTextureCoords = " << bottomLeftTextureCoords.x << "\n" << bottomLeftTextureCoords.y
            //    << std::endl;

            float imgW = 200.0f;
            float imgH = 200.0f;
            //topLeftTextureCoords.x = std::max(topLeftTextureCoords.x, 200.0f);
            //topLeftTextureCoords.y = std::max(topLeftTextureCoords.y, 200.0f);
            bottomLeftTextureCoords.x = std::max(topLeftTextureCoords.x + 200.0f, bottomLeftTextureCoords.x);
            bottomLeftTextureCoords.y = std::max(topLeftTextureCoords.y + 200.0f, bottomLeftTextureCoords.y);

            drawList->AddImage((ImTextureID)postProcOutput->ID64(),
                               topLeftTextureCoords,
                               bottomLeftTextureCoords,
                               {0, 1}, {1, 0});
					...
					ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(10.0f, 10.0f));
						ImGui::BeginTooltip();
							ImGui::BeginGroup();
                                ...
                                ImGui::ColorButton("MyColor##3c", pixelColor, 0, ImVec2(20, 20));
								ImGui::SameLine();
