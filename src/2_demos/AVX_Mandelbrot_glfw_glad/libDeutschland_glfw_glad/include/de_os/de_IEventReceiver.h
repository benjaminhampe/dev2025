...
getEventTypeStr( SEventType const eventType )
{
   switch ( eventType )
   {
      ...
      case SEventType::PAINT: return "PAINT";
...
// ========================================================================
{
   KEY_ESCAPE = 0, KEY_ENTER, KEY_SPACE, KEY_BACKSPACE, KEY_TAB,
...
*/
   ...
   KEY_UNKNOWN // this is not a key, but the amount of keycodes there are.
};
...
// ========================================================================
{
   ...
   */
   ...
   std::string toString() const
   {
      ...
      case SEventType::PAINT: o << paintEvent.toString(); break;
   ...
   ~SEvent() {}
   SEvent(PaintEvent event) : type(SEventType::PAINT), paintEvent(event) {}
