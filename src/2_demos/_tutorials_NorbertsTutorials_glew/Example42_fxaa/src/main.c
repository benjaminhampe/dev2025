...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example42_fxaa/shader/fxaa.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example42_fxaa/shader/fxaa.frag.glsl", &fragmentSource);

    glusProgramBuildFromSource( &g_program,
...
int main(int argc, char* argv[])
{
   ...
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example42_fxaa Window", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
