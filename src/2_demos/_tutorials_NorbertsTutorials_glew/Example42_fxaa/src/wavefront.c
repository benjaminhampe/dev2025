/**
 * OpenGL 4 - Example 42 - Rendering of the wavefront object
 *
...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("../../src/Example42_fxaa/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example42_fxaa/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("../../media/Example42_fxaa/elephant.obj", &wavefrontObj);
