...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example05_phong/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example05_phong/shader/phong.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example05_phong Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
