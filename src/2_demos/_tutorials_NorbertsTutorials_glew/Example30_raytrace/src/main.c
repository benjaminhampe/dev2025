...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example30_raytrace/shader/fullscreen.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example30_raytrace/shader/texture.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example30_raytrace/shader/raytrace.comp.glsl", &computeSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example30_raytrace Window", WIDTH, HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
