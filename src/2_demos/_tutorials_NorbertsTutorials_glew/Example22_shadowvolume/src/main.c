...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example22_shadowvolume/shader/color.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example22_shadowvolume/shader/color.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example22_shadowvolume/shader/shadowvolume.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example22_shadowvolume/shader/shadowvolume.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example22_shadowvolume/shader/shadowvolume.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example22_shadowvolume/shader/shadow.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example22_shadowvolume/shader/shadow.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example22_shadowvolume Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
