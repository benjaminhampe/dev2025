...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example32_brdf/shader/brdf.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example32_brdf/shader/brdf.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example32_brdf/shader/fullscreen.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example32_brdf/shader/fullscreen.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example32_brdf/shader/background.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example32_brdf/shader/background.frag.glsl", &fragmentSource);
   ...
   if (!glusImageLoadHdr("../../media/Example32_brdf/doge2.hdr", &image))
   {
      printf("failed!\n");
   ...
   glusShapeLoadWavefront("../../media/Example32_brdf/venusm.obj", &wavefront);
...
int main(int argc, char* argv[])
{
   ...
   // No resize, as it makes code simpler.
    if (!glusWindowCreate("GLUS Example32_brdf Window", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
