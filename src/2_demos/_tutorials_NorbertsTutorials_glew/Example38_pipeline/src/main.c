...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example38_pipeline/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example38_pipeline/shader/red.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example38_pipeline Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
