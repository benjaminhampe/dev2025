...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example15_water/shader/Water.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example15_water/shader/Water.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example15_water/water_pos_x.tga", &image);
    ...
    glusImageLoadTga("../../media/Example15_water/water_neg_x.tga", &image);
    ...
    glusImageLoadTga("../../media/Example15_water/water_pos_y.tga", &image);
    ...
    glusImageLoadTga("../../media/Example15_water/water_neg_y.tga", &image);
    ...
    glusImageLoadTga("../../media/Example15_water/water_pos_z.tga", &image);
    ...
    glusImageLoadTga("../../media/Example15_water/water_neg_z.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example15_water Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
