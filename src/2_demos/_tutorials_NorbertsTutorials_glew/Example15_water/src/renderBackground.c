...
GLUSboolean initBackground()
{
    ...
    glusFileLoadText("../../src/Example15_water/shader/Background.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example15_water/shader/Background.frag.glsl", &fragmentSource);
