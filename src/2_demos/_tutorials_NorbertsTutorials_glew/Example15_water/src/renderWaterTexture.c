...
GLUSuint initWaterTexture(GLUSfloat waterPlaneLength)
{
	...
	glusFileLoadText("../../src/Example15_water/shader/WaterTexture.vert.glsl", &vertexSource);
	glusFileLoadText("../../src/Example15_water/shader/WaterTexture.frag.glsl", &fragmentSource);
