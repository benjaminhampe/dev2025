...
GLUSboolean init(GLUSvoid)
{
   ...
   GLfloat halfPixelSize[2];
    ...
    glusFileLoadText("../../src/Example45_voxelize/shader/voxelize.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example45_voxelize/shader/voxelize.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example45_voxelize/shader/voxelize.frag.glsl", &fragmentSource);
   ...
   glusWavefrontLoad("../../media/Example45_voxelize/ChessKing.obj", &g_wavefront);
   ...
   glBindTexture(GL_TEXTURE_3D, 0);
    ...
    glusFileLoadText("../../src/Example45_voxelize/shader/fullscreen.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example45_voxelize/shader/draw_voxels.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example45_voxelize Window", WINDOW_SIZE, WINDOW_SIZE, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
