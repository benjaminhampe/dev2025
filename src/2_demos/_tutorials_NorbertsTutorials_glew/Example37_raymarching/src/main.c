...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example37_raymarching/shader/fullscreen.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example37_raymarching/shader/texture.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   ...
   // To keep the program simple, no resize of the window.
    if (!glusWindowCreate("GLUS Example37_raymarching Window", WIDTH, HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
