...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText("../../src/Example25_phong_textured/shader/phong_textured.vert.glsl", &vertexSource);
	glusFileLoadText("../../src/Example25_phong_textured/shader/phong_textured.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example25_phong_textured Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
