...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example04_color/shader/basic.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example04_color/shader/color.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example04_color Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
