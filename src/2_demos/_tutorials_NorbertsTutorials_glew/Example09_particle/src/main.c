...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example09_particle/shader/particle.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example09_particle/shader/particle.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example09_particle/shader/update_points.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example09_particle/shader/update_points.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example09_particle/particle.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example09_particle Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
