...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example43_phong_textured/shader/phong_textured.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example43_phong_textured/shader/phong_textured.frag.glsl", &fragmentSource);
   ...
   glusWavefrontLoadScene("../../media/Example43_phong_textured/three_objects.obj", &g_scene);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example43_phong_textured Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
