...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example02_simple/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example02_simple/shader/red.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example02_simple Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
