...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText("../../src/Example13_tessellation/shader/tessellation.vert.glsl", &vertexSource);
	glusFileLoadText("../../src/Example13_tessellation/shader/tessellation.cont.glsl", &controlSource);
	glusFileLoadText("../../src/Example13_tessellation/shader/tessellation.eval.glsl", &evaluationSource);
	glusFileLoadText("../../src/Example13_tessellation/shader/tessellation.geom.glsl", &geometrySource);
	glusFileLoadText("../../src/Example13_tessellation/shader/tessellation.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example13_tessellation Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
