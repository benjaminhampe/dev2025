...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example19_multi_proj/shader/basic_proj.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example19_multi_proj/shader/texture_multi_proj.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example19_multi_proj/ice.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example19_multi_proj Window", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
