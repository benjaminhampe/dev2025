...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("../../src/Example19_multi_proj/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example19_multi_proj/shader/phong.frag.glsl", &fragmentSource);
