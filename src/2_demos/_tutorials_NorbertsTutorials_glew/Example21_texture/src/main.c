...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example21_texture/shader/texture.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example21_texture/shader/texture.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example21_texture/shader/texture.comp.glsl", &computeSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example21_texture Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
