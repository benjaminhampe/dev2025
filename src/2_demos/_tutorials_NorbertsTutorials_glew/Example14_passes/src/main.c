 ...
 */
static const char* HEIGHT_MAP = "../../media/Example14_passes/grand_canyon_height.tga";

/**
 * The color map of the terrain.
 */
static const char* COLOR_MAP = "../../media/Example14_passes/grand_canyon_color.tga";

/**
 * The normal map of the terrain. Width and height does not have to be the same but they have to be power of two plus one.
 */
static const char* NORMAL_MAP = "../../media/Example14_passes/grand_canyon_normal.tga";
...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example14_passes/shader/PassOne.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example14_passes/shader/PassOne.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example14_passes/shader/PassOne.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example14_passes/shader/PassTwo.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example14_passes/shader/PassTwo.cont.glsl", &controlSource);
    glusFileLoadText("../../src/Example14_passes/shader/PassTwo.eval.glsl", &evaluationSource);
    glusFileLoadText("../../src/Example14_passes/shader/PassTwo.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example14_passes/shader/PassTwo.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example14_passes Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
