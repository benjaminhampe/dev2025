...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example08_cubemap/shader/cubemap.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example08_cubemap/shader/cubemap.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example08_cubemap Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
