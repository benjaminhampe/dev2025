...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example12_shadow/shader/rendershadow.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example12_shadow/shader/rendershadow.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example12_shadow/shader/useshadow.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example12_shadow/shader/useshadow.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example12_shadow Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
