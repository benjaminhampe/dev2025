...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example24_erode/shader/erode.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example24_erode/shader/erode.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example24_erode Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
