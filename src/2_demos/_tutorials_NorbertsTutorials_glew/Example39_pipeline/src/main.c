...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example39_pipeline/shader/offset.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example39_pipeline/shader/red_green_blue.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example39_pipeline Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
