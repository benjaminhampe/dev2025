...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example11_glass/shader/glass.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example11_glass/shader/glass.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example11_glass/shader/background.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example11_glass/shader/background.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_pos_x.tga", &image);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_neg_x.tga", &image);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_pos_y.tga", &image);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_neg_y.tga", &image);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_pos_z.tga", &image);
    ...
    glusImageLoadTga("../../media/Example08_cubemap/cm_neg_z.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example11_glass Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
