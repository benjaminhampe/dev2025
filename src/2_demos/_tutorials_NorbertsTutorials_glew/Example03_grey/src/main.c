...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example03_grey/shader/texture.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example03_grey/shader/grey.frag.glsl", &fragmentSource);
    ...
    // Load the image.
    glusImageLoadTga("../../media/Example03_grey/desert.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example03_grey Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
