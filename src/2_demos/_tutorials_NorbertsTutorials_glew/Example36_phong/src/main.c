...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example36_phong/shader/phong_linked_list.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example36_phong/shader/phong_linked_list.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example36_phong/shader/fullscreen_blend.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example36_phong/shader/fullscreen_blend.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example36_phong Window", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
