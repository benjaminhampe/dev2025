...
GLUSboolean init(GLUSvoid)
{
   ...
   GLchar buffer[48] = "../../media/Example33_brdf/doge2_POS_X_00_s.hdr"; // 27

   GLint i, k, m;

   //

   glusFileLoadText("../../src/Example33_brdf/shader/brdf.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example33_brdf/shader/brdf.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example33_brdf/shader/fullscreen.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example33_brdf/shader/fullscreen.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example33_brdf/shader/background.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example33_brdf/shader/background.frag.glsl", &fragmentSource);
   ...
   printf("Loading '../../media/Example33_brdf/EnvironmentBRDF_1024.data' ...");
    if (!glusFileLoadBinary("../../media/Example33_brdf/EnvironmentBRDF_1024.data", &rawimage))
    {
      printf(" error!\n");
    }
    else
   ...
   glusShapeLoadWavefront("../../media/Example33_brdf/venusm.obj", &wavefront);
...
int main(int argc, char* argv[])
{
   ...
   // No resize, as it makes code simpler.
    if (!glusWindowCreate("GLUS Example33_brdf Window", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
