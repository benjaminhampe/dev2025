...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText("../../src/Example23_tessellation/shader/tessellation.vert.glsl", &vertexSource);
	glusFileLoadText("../../src/Example23_tessellation/shader/tessellation.cont.glsl", &controlSource);
	glusFileLoadText("../../src/Example23_tessellation/shader/tessellation.eval.glsl", &evaluationSource);
	glusFileLoadText("../../src/Example23_tessellation/shader/tessellation.geom.glsl", &geometrySource);
	glusFileLoadText("../../src/Example23_tessellation/shader/tessellation.frag.glsl", &fragmentSource);
    ...
    // Load the image.
    glusImageLoadTga("../../media/Example23_tessellation/four_shapes_color.tga", &image);
    ...
    // Load the image.
    glusImageLoadTga("../../media/Example23_tessellation/four_shapes_normal.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example23_tessellation Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
