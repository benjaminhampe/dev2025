...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example35_depth_peel/shader/phong_depth_peel.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example35_depth_peel/shader/phong_depth_peel.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example35_depth_peel/shader/fullscreen_blend.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example35_depth_peel/shader/fullscreen_blend.frag.glsl", &fragmentSource);
   ...
   g_layersBlendFullscreenLocation = glGetUniformLocation(g_blendFullscreenProgram.program, "u_layers");
    ...
    glusShapeLoadWavefront("../../media/Example34_depthmap/dragon.obj", &wavefrontObj);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example35_depth_peel Window", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
