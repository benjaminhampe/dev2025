...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example40_cloth/shader/cloth.comp.glsl", &computeSource);
    ...
    glusFileLoadText("../../src/Example40_cloth/shader/cloth.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example40_cloth/shader/cloth.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example40_cloth Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
