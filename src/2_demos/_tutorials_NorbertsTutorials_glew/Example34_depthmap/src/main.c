...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example34_depthmap/shader/renderdepthmap.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example34_depthmap/shader/renderdepthmap.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example34_depthmap/shader/subsurfacescattering.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example34_depthmap/shader/subsurfacescattering.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example34_depthmap Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
