...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example28_ssao_blur/shader/texture.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example28_ssao_blur/shader/texture.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example28_ssao_blur/shader/ssao.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example28_ssao_blur/shader/ssao.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example28_ssao_blur/shader/blur.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example28_ssao_blur/shader/blur.frag.glsl", &fragmentSource);
   ...
   glusImageLoadTga("../../media/Example28_ssao_blur/wood_texture.tga", &image);
...
int main(int argc, char* argv[])
{
   ...
   // No resizing for convenience. If resizing is allowed, dynamically resize the SSAO and Blur frame buffer as well.
    if (!glusWindowCreate("GLUS Example28_ssao_blur Window", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
