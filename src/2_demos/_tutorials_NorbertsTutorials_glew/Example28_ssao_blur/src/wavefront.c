/**
 * OpenGL 4 - Example 28 - Rendering of the wavefront object
 *
...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("../../src/Example28_ssao_blur/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example28_ssao_blur/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("../../media/Example28_ssao_blur/teapot.obj", &wavefrontObj);
