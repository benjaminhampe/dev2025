...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example26_fur/shader/ambient_diffuse_texture.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example26_fur/shader/ambient_diffuse_texture.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example26_fur/shader/fur.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example26_fur/shader/fur.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example26_fur/shader/fur.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example26_fur/tiger.tga", &image);
    ...
    glusShapeLoadWavefront("../../media/Example26_fur/bunny.obj", &bunnyShape);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example26_fur Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
