...
GLUSboolean init(GLUSvoid)
{
   ...
   while (!(temp & 0x1))
   {
    ...
    glusFileLoadText("../../src/Example41_ocean/shader/ocean_update_ht.comp.glsl", &computeSource);
    ...
    glusFileLoadText("../../src/Example41_ocean/shader/ocean_fft.comp.glsl", &computeSource);
    ...
    glusFileLoadText("../../src/Example41_ocean/shader/ocean_update_normal.comp.glsl", &computeSource);
    ...
    glusFileLoadText("../../src/Example41_ocean/shader/ocean.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example41_ocean/shader/ocean.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example41_ocean Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
