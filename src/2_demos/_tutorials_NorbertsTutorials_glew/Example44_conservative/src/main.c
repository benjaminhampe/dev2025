...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example44_conservative/shader/conservative.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example44_conservative/shader/conservative.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example44_conservative/shader/conservative.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example44_conservative Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
