...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example20_checker/shader/checker.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example20_checker/shader/checker.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example20_checker Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
