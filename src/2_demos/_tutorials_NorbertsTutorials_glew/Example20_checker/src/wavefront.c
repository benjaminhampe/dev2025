...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("../../src/Example20_checker/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example20_checker/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("../../media/Example20_checker/elephant.obj", &wavefrontObj);
