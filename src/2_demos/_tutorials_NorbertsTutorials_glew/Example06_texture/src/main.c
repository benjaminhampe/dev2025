...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example06_texture/shader/basic.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example06_texture/shader/texture.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example06_texture/crate.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example06_texture Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
