...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example07_normmap/shader/normmap.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example07_normmap/shader/normmap.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/Example07_normmap/rock_color.tga", &image);
    ...
    glusImageLoadTga("../../media/Example07_normmap/rock_normal.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example07_normmap Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
