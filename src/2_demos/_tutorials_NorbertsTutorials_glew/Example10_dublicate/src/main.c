...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example10_dublicate/shader/dublicate.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example10_dublicate/shader/dublicate.geom.glsl", &geometrySource);
    glusFileLoadText("../../src/Example10_dublicate/shader/dublicate.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example10_dublicate Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
