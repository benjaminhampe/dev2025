...
GLUSboolean init(GLUSvoid)
{
   ...
   glusFileLoadText("../../src/Example31_deferred_shading/shader/point_light.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example31_deferred_shading/shader/point_light.frag.glsl", &fragmentSource);
   ...
   glusFileLoadText("../../src/Example31_deferred_shading/shader/deferred_shading.vert.glsl", &vertexSource);
   glusFileLoadText("../../src/Example31_deferred_shading/shader/deferred_shading.frag.glsl", &fragmentSource);
   ...
   glusWavefrontLoad("../../media/Example31_deferred_shading/ChessPawn.obj", &g_wavefront);
...
int main(int argc, char* argv[])
{
   EGLint eglConfigAttributes[] = {
    ...
    if (!glusWindowCreate("GLUS Example31_deferred_shading Window", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
