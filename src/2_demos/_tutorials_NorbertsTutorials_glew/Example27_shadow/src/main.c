...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example27_shadow/shader/shadow.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example27_shadow/shader/shadow.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../../src/Example27_shadow/shader/color.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example27_shadow/shader/color.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example27_shadow Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
