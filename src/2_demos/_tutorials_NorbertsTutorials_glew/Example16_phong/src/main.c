...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../../src/Example16_phong/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../../src/Example16_phong/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("../../media/Example16_phong/monkey.obj", &wavefrontObj);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("GLUS Example16_phong Window", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
