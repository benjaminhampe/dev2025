...
// ===================================================================
// INCLUDE: Creation Params
// ===================================================================
#include <de/CreateParams.hpp>

// ===================================================================
// INCLUDE: EventReceiver
// ===================================================================
#include <de/IEventReceiver.hpp>

// ===================================================================
// INCLUDE: OpenGL commands (glew)
// ===================================================================
...
struct OpenGLWindow_WGL
{
   ...
   void setEventReceiver( de::IEventReceiver* receiver );
   de::IEventReceiver* getEventReceiver();

   bool getKeyState( de::EKEY key ) const;
...
protected:
   ...
   de::IEventReceiver* m_eventReceiver;
