...
OpenGLWindow_WGL::OpenGLWindow_WGL()
   : m_hInstance( nullptr )
   , m_hWnd( nullptr )
   , m_hDC( nullptr )
   , m_hRC( nullptr )
...
void OpenGLWindow_WGL::yield( int ms )
{
   if ( ms < 1 ) ms = 1;
...
void
OpenGLWindow_WGL::setEventReceiver( de::IEventReceiver* receiver )
{
   m_eventReceiver = receiver;
}

de::IEventReceiver*
OpenGLWindow_WGL::getEventReceiver()
{
   return m_eventReceiver;
}

void
OpenGLWindow_WGL::requestClose()
{
   if ( m_hWnd )
   {
...
bool
OpenGLWindow_WGL::create( CreateParams params )
{
   m_params = params;
...
OpenGLWindow_WGL_WndProc( HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam )
{
   OpenGLWindow_WGL* glwin = nullptr;
   if ( message == WM_NCCREATE )
   {
      glwin = static_cast< OpenGLWindow_WGL* >(
   ...
   {
      glwin = reinterpret_cast< OpenGLWindow_WGL* >( GetWindowLongPtr( hwnd, GWL_USERDATA ) );
   }
...
*/
      ...
      case WM_SIZE: {
         ...
         std::ostringstream o;
         o << "OpenGLWindow_WGL (c) 2023 by BenjaminHampe@gmx.de | "
...
// [Keyboard] Convert Benni's de::EKEY to Windows VK_Key [ used in getKeyState() ]

int
convert_EKEY_to_WinVK( de::EKEY ekey )
{
   switch ( ekey )
   {
      case de::KEY_0: return 48; // No VK enums for these? Are they all language dependent aswell?
      case de::KEY_1: return 49;
      case de::KEY_2: return 50;
      case de::KEY_3: return 51;
      case de::KEY_4: return 52;
      case de::KEY_5: return 53;
      case de::KEY_6: return 54;
      case de::KEY_7: return 55;
      case de::KEY_8: return 56;
      case de::KEY_9: return 57;

      case de::KEY_A: return 65; // No VK enums for these? Are they all language dependent aswell?
      case de::KEY_B: return 66;
      case de::KEY_C: return 67;
      case de::KEY_D: return 68;
      case de::KEY_E: return 69;
      case de::KEY_F: return 70;
      case de::KEY_G: return 71;
      case de::KEY_H: return 72;
      case de::KEY_I: return 73;
      case de::KEY_J: return 74;
      case de::KEY_K: return 75;
      case de::KEY_L: return 76;
      case de::KEY_M: return 77;
      case de::KEY_N: return 78;
      case de::KEY_O: return 79;
      case de::KEY_P: return 80;
      case de::KEY_Q: return 81;
      case de::KEY_R: return 82;
      case de::KEY_S: return 83;
      case de::KEY_T: return 84;
      case de::KEY_U: return 85;
      case de::KEY_V: return 86;
      case de::KEY_W: return 87;
      case de::KEY_X: return 88;
      case de::KEY_Y: return 89;
      case de::KEY_Z: return 90;

      case de::KEY_F1: return VK_F1;
      case de::KEY_F2: return VK_F2;
      case de::KEY_F3: return VK_F3;
      case de::KEY_F4: return VK_F4;
      case de::KEY_F5: return VK_F5;
      case de::KEY_F6: return VK_F6;
      case de::KEY_F7: return VK_F7;
      case de::KEY_F8: return VK_F8;
      case de::KEY_F9: return VK_F9;
      case de::KEY_F10: return VK_F10;
      case de::KEY_F11: return VK_F11;
      case de::KEY_F12: return VK_F12;
      case de::KEY_F13: return VK_F13;
      case de::KEY_F14: return VK_F14;
      case de::KEY_F15: return VK_F15;
      case de::KEY_F16: return VK_F16;
      case de::KEY_F17: return VK_F17;
      case de::KEY_F18: return VK_F18;
      case de::KEY_F19: return VK_F19;
      case de::KEY_F20: return VK_F20;
      case de::KEY_F21: return VK_F21;
      case de::KEY_F22: return VK_F22;
      case de::KEY_F23: return VK_F23;
      case de::KEY_F24: return VK_F24;

      case de::KEY_ESCAPE: return VK_ESCAPE;
      case de::KEY_ENTER: return VK_RETURN;
      case de::KEY_BACKSPACE: return VK_BACK;
      case de::KEY_SPACE: return VK_SPACE;
      case de::KEY_TAB: return VK_TAB;
      case de::KEY_LEFT_SHIFT: return VK_LSHIFT;
      case de::KEY_RIGHT_SHIFT: return VK_RSHIFT;

      case de::KEY_LEFT_SUPER: return VK_LWIN;
      case de::KEY_RIGHT_SUPER: return VK_RWIN;
      case de::KEY_LEFT_CTRL: return VK_LCONTROL;
      case de::KEY_RIGHT_CTRL: return VK_RCONTROL;

      case de::KEY_LEFT_ALT: return VK_LMENU;
      case de::KEY_RIGHT_ALT: return VK_RMENU;

      // OEM special keys: All German Umlaute so far and special characters
      // I dont own US or Japanese keyboards. Please add your special chars if needed.
      case de::KEY_OEM_1: return VK_OEM_1;            // Ü, VK_OEM_1 = 186 = 0xBA
      case de::KEY_OEM_PLUS: return VK_OEM_PLUS;      // VK_OEM_PLUS = 187 = 0xBB
      case de::KEY_OEM_COMMA: return VK_OEM_COMMA;    // VK_OEM_COMMA = 188 = 0xBC
      case de::KEY_OEM_MINUS: return VK_OEM_MINUS;    // VK_OEM_MINUS = 189 = 0xBD
      case de::KEY_OEM_PERIOD: return VK_OEM_PERIOD;  // VK_OEM_PERIOD = 190 = 0xBE
      case de::KEY_OEM_2: return VK_OEM_2;            // VK_OEM_2 = 191 = 0xBF
      case de::KEY_OEM_3: return VK_OEM_3;            // Ö, VK_OEM_3 = 192 = 0xC0
      case de::KEY_OEM_4: return VK_OEM_4;            // ß, VK_OEM_4 = 219 = 0xDB
      case de::KEY_OEM_5: return VK_OEM_5;            // VK_OEM_5 = 220 = 0xDC
      case de::KEY_OEM_6: return VK_OEM_6;            // VK_OEM_6 = 221 = 0xDD
      case de::KEY_OEM_7: return VK_OEM_7;            // Ä, VK_OEM_7 = 222 = 0xDE
      case de::KEY_OEM_102: return VK_OEM_102;        // <|>, VK_OEM_8 = 226 = 0xDE

      // 4x Arrow keys:
      case de::KEY_UP: return VK_UP;
      case de::KEY_LEFT: return VK_LEFT;
      case de::KEY_DOWN: return VK_DOWN;
      case de::KEY_RIGHT: return VK_RIGHT;

      // 3x control buttons:
      case de::KEY_SNAPSHOT: return VK_SNAPSHOT; // PRINT SCREEN, not the PRINT (only) key
      case de::KEY_SCROLL_LOCK: return VK_SCROLL;
      case de::KEY_PAUSE: return VK_PAUSE;

      // 6x control buttons:
      case de::KEY_INSERT: return VK_INSERT;
      case de::KEY_HOME: return VK_HOME;
      case de::KEY_END: return VK_END;
      case de::KEY_DELETE: return VK_DELETE;
      case de::KEY_PAGE_UP: return VK_PRIOR;
      case de::KEY_PAGE_DOWN: return VK_NEXT;

      // Numpad:
      case de::KEY_NUM_LOCK: return VK_NUMLOCK;
      case de::KEY_KP_0: return VK_NUMPAD0;
      case de::KEY_KP_1: return VK_NUMPAD1;
      case de::KEY_KP_2: return VK_NUMPAD2;
      case de::KEY_KP_3: return VK_NUMPAD3;
      case de::KEY_KP_4: return VK_NUMPAD4;
      case de::KEY_KP_5: return VK_NUMPAD5;
      case de::KEY_KP_6: return VK_NUMPAD6;
      case de::KEY_KP_7: return VK_NUMPAD7;
      case de::KEY_KP_8: return VK_NUMPAD8;
      case de::KEY_KP_9: return VK_NUMPAD9;

      case de::KEY_KP_MULTIPLY: return VK_MULTIPLY; // Is that correct mapping?
      case de::KEY_KP_ADD: return VK_ADD; // Is that correct mapping?
      //case de::KEY_KP_SEPARATOR: return VK_SEPARATOR; // Is that correct mapping?
      case de::KEY_KP_SUBTRACT: return VK_SUBTRACT; // Is that correct mapping?
      case de::KEY_KP_DECIMAL: return VK_DECIMAL; // Is that correct mapping?
      case de::KEY_KP_DIVIDE: return VK_DIVIDE; // Is that correct mapping?

      default:
      {
         #ifdef BENNI_USE_COUT
         std::cout << "Cant translate EKEY(" << de::EKEY_to_String(ekey) << ")" << std::endl;
         #endif
         return 0;
      }
   }
...
bool
OpenGLWindow_WGL::getKeyState( de::EKEY ekey ) const
{
...
int
OpenGLWindow_WGL::getDesktopWidth() const
{
   return GetSystemMetrics( SM_CXSCREEN );
}

int
OpenGLWindow_WGL::getDesktopHeight() const
{
   return GetSystemMetrics( SM_CYSCREEN );
}

int
OpenGLWindow_WGL::getWindowWidth() const
{
   RECT r_window;
...
int
OpenGLWindow_WGL::getWindowHeight() const
{
   RECT r_window;
   GetWindowRect( m_hWnd, &r_window );
...
int
OpenGLWindow_WGL::getWindowPosX() const
{
   RECT r_window;
   GetWindowRect( m_hWnd, &r_window );
...
int
OpenGLWindow_WGL::getWindowPosY() const
{
   RECT r_window;
   GetWindowRect( m_hWnd, &r_window );
   return r_window.top;
...
int
OpenGLWindow_WGL::getClientWidth() const
{
   return m_screenWidth;
}

int
OpenGLWindow_WGL::getClientHeight() const
{
   return m_screenHeight;
}

void
OpenGLWindow_WGL::setWindowTitle( char const* title )
{
...
void
OpenGLWindow_WGL::setWindowIcon( int iRessourceID )
{
   if ( !m_hWnd )
   {
      return;
...
void
OpenGLWindow_WGL::setResizable( bool resizable )
{
   if ( !m_hWnd )
   {
      return;
...
void OpenGLWindow_WGL::setFullScreen( bool fullscreen )
{
   DWORD style;
