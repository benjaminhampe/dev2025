...
// ===========================================================================
{
   ...
   static Font5x8::TextSize
   getTextSize5x8( std::string const & msg, Font5x8 font = Font5x8() );

   static void
   drawText5x8(Image & img, int32_t x, int32_t y, std::string const & msg, 
               uint32_t color, Font5x8 font = Font5x8(), 
               Align align = Align::Default, bool blend = false );
   ...
   {
      drawLine( img, r.getX1(), r.getY1(), r.getX2(), r.getY2(), color, blend );
   }
...
// Circle/Ellipse + RoundRect
   static void
   drawCircle( Image & img, int cx, int cy, int r, uint32_t color, bool blend = false );
   static void
   drawCircleBorder( Image & img, int cx, int cy, int r, uint32_t color, bool blend = false );
...
// ===========================================================================
{
   DE_CREATE_LOGGER("de.ImageScaler")
public:
