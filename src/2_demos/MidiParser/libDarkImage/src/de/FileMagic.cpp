...
/// ImageMagic
// ============================================================================
bool isFileMagic_JPG( void* ptr );
bool isFileMagic_PNG( void* ptr );
bool isFileMagic_BMP( void* ptr );
bool isFileMagic_GIF( void* ptr );
bool isFileMagic_TIF( void* ptr );
bool isFileMagic_TGA( void* ptr );
bool isFileMagic_PCX( void* ptr );

// ============================================================================
/// AudioMagic
// ============================================================================
bool isFileMagic_AAC( void* ptr );
bool isFileMagic_WAV( void* ptr );
bool isFileMagic_MP3( void* ptr );
bool isFileMagic_MP4( void* ptr );
bool isFileMagic_FLAC( void* ptr );
bool isFileMagic_OGG( void* ptr );
bool isFileMagic_WMA( void* ptr );
bool isFileMagic_M4A( void* ptr );
bool isFileMagic_FLV( void* ptr );
...
{
   if ( !ptr ) return EFT_UNKNOWN;

   if      (isFileMagic_JPG( ptr )) return EFT_JPG;
   else if (isFileMagic_PNG( ptr )) return EFT_PNG;
   else if (isFileMagic_BMP( ptr )) return EFT_BMP;
   else if (isFileMagic_GIF( ptr )) return EFT_GIF;
   else if (isFileMagic_TIF( ptr )) return EFT_TIF;
   else if (isFileMagic_TGA( ptr )) return EFT_TGA;
   else if (isFileMagic_PCX( ptr )) return EFT_PCX;

   else if (isFileMagic_WAV( ptr )) return EFT_WAV;
   else if (isFileMagic_AAC( ptr )) return EFT_AAC;
   else if (isFileMagic_MP3( ptr )) return EFT_MP3;
   else if (isFileMagic_MP4( ptr )) return EFT_MP4;
   else if (isFileMagic_M4A( ptr )) return EFT_M4A;
   else if (isFileMagic_FLAC( ptr ))return EFT_FLAC;
   else if (isFileMagic_OGG( ptr )) return EFT_OGG;
   else if (isFileMagic_WMA( ptr )) return EFT_WMA;
   else if (isFileMagic_FLV( ptr )) return EFT_FLV;

   else return EFT_UNKNOWN;
}

std::string
convertFileMagic2String( EFileType fileType )
{
   switch (fileType)
   {
   case EFT_JPG: return "JPG";
   case EFT_PNG: return "PNG";
   case EFT_BMP: return "BMP";
   case EFT_GIF: return "GIF";
   case EFT_TIF: return "TIF";
   case EFT_TGA: return "TGA";
   case EFT_PCX: return "PCX";

   case EFT_WAV: return "WAV";
   case EFT_AAC: return "AAC";
   case EFT_MP3: return "MP3";
   case EFT_MP4: return "MP4";
   case EFT_M4A: return "M4A";
   case EFT_FLAC:return "FLAC";
   case EFT_OGG: return "OGG";
   case EFT_WMA: return "WMA";
   case EFT_FLV: return "FLV";
...
bool
isFileMagic_AAC( void* ptr )
{
   return false;
}

bool
isFileMagic_WAV( void* ptr )
{
   return false;
}

bool
isFileMagic_MP3( void* ptr )
{
   return false;
}

bool
isFileMagic_MP4( void* ptr )
{
   return false;
}

bool
isFileMagic_FLAC( void* ptr )
{
   return false;
}

bool
isFileMagic_OGG( void* ptr )
{
   return false;
}

bool
isFileMagic_WMA( void* ptr )
{
   return false;
}

bool
isFileMagic_M4A( void* ptr )
{
   return false;
}
