...
#define MIDI_CC               0xB0  // Bn Control Change | Bn cc xx, cc = controller (0-121) xx = value (0-127)
                                    // 120 - Bn All Sound Off           Bn 78 00
                                    // 121 - Bn Reset All Controllers   Bn 79 00
                                    // 122 - Bn Local Control           Bn 7A xx xx = 0 (off), 127 (on)
                                    // 123 - Bn All Notes Off           Bn 7B 00
                                    // 124 - Bn Omni Mode Off           Bn 7C 00
                                    // 125 - Bn Omni Mode On            Bn 7D 00
                                    // 126 - Bn Mono Mode On            Bn 7E cc cc = number of channels
                                    // 127 - Bn Poly Mode On            Bn 7F 00
