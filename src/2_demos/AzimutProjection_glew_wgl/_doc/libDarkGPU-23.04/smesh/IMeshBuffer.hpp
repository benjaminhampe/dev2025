...
// =======================================================================
{
   ...
   virtual bool                  upload( int mode = 1 ) = 0;
   ...
   virtual uint32_t              getPrimitiveCount() const { return getPrimitiveTypeCount( getPrimitiveType(), getVertexCount(), getIndexCount() ); }
   virtual std::string           getPrimitiveTypeStr() const { return getPrimitiveTypeString( getPrimitiveType() ); }
...
// virtual void                  addIndexedQuad( uint32_t a, uint32_t b, uint32_t c, uint32_t d ) = 0;
   ...
   virtual void                  setMaterial( Material const & material ) = 0;
   ...
   virtual uint32_t countTriangle() const
   {
      if ( getIndexCount() > 0 )
      {
