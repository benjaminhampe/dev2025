...
{
   LOG = 0,       //! A log event
   //WINDOW_RESHAPE,//! An event of the (underlying) native window.
   WINDOW_RESIZE, //! An event of the (underlying) native window.
   WINDOW_MOVE,   //! An event of the (underlying) native window.
   WINDOW_PAINT,  //! An event of the (underlying) native window.
...
getEventTypeStr( SEventType const eventType )
{
   switch ( eventType )
   {
      ...
      case SEventType::WINDOW_RESIZE: return "WINDOW_RESIZE";
      case SEventType::WINDOW_MOVE: return "WINDOW_MOVE";
      case SEventType::WINDOW_PAINT: return "WINDOW_PAINT";
...
// ========================================================================
{
   ...
   static void dump()
   {
      ...
      DE_DEBUG("sizeof(PaintEvent) = ",sizeof(PaintEvent))
   ...
   */
   ...
   std::string toString() const
   {
      ...
      case SEventType::WINDOW_RESIZE: o << resizeEvent.toString(); break;
      case SEventType::WINDOW_MOVE: o << windowMoveEvent.toString(); break;
      case SEventType::WINDOW_PAINT: o << paintEvent.toString(); break;
   ...
   ~SEvent() {}
   SEvent(ResizeEvent event) : type(SEventType::WINDOW_RESIZE), resizeEvent(event) {}
   SEvent(WindowMoveEvent event) : type(SEventType::WINDOW_MOVE), windowMoveEvent(event) {}
   SEvent(PaintEvent event) : type(SEventType::WINDOW_PAINT), paintEvent(event) {}
...
// =======================================================================
{
   ...
   virtual void windowShowed( Window* window ) {}
   virtual void windowHidden( Window* window ) {}

   virtual void windowCreated( Window* window ) {}
   virtual void windowAboutToBeDestroyed( Window* window ) {}
