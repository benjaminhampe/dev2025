...
// ------------------------------------------------------------------------
void GL_Shader::setVec1b(std::string const & name, bool value) const
{
   setVec1i(name, (int)value);
}
void GL_Shader::setVec1i(std::string const & name, int value) const
{
   glUniform1i(glGetUniformLocation(ID, name.c_str()), value);
}
void GL_Shader::setVec1f(std::string const & name, float value) const
{
   glUniform1f(glGetUniformLocation(ID, name.c_str()), value);
}
void GL_Shader::setVec2f(std::string const & name, glm::vec2 const &value) const
{
   glUniform2fv(glGetUniformLocation(ID, name.c_str()), 1, glm::value_ptr( value ));
}
void GL_Shader::setVec3f(std::string const & name, glm::vec3 const &value) const
{
   glUniform3fv(glGetUniformLocation(ID, name.c_str()), 1, glm::value_ptr( value ));
}
void GL_Shader::setVec4f(std::string const & name, glm::vec4 const &value) const
{
   glUniform4fv(glGetUniformLocation(ID, name.c_str()), 1, glm::value_ptr( value ));
}
// ------------------------------------------------------------------------
void GL_Shader::setMat2f(std::string const & name, glm::mat2 const &mat) const
{
   glUniformMatrix2fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, glm::value_ptr( mat ));
}
void GL_Shader::setMat3f(std::string const & name, glm::mat3 const &mat) const
{
   glUniformMatrix3fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, glm::value_ptr( mat ));
}
void GL_Shader::setMat4f(std::string const & name, glm::mat4 const &mat) const
{
