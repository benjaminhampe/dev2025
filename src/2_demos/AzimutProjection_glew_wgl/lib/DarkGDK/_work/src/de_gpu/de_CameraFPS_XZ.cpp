...
Ray3d
CameraFPS_XZ::computeRay( int mx, int my ) const
{
   int w = getWidth();
   int h = getHeight();
...
Ray3f
CameraFPS_XZ::computeRayf( int mouse_x, int mouse_y ) const
{
...
// ViewMatrix
void
CameraFPS_XZ::lookAt( V3 pos, V3 target, V3 up )
{
   m_Pos = pos;
   m_Target = target;
   m_Up = up;
...
// Viewport
void
CameraFPS_XZ::setViewport( Recti const & viewport )
{
...
// ProjectionMatrix
void
CameraFPS_XZ::setProjectionMode( bool ortho )
{
...
void
CameraFPS_XZ::setNearValue( T nearValue )
{
...
void
CameraFPS_XZ::setFarValue( T farValue )
{
...
void
CameraFPS_XZ::setFOV( T fovy_degrees )
{
 ...
 *
void
CameraFPS_XZ::onEvent( SEvent const & event )
{
...
void
CameraFPS_XZ::onAnimate( double seconds )
{
