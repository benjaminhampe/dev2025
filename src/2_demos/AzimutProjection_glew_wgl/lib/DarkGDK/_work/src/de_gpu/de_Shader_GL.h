...
// ////////////////////////////
{
   ...
   // uniform setter
   // ------------------------------------------------------------------------
   void setVec1b(std::string const & name, bool value) const override;
   void setVec1i(std::string const & name, int value) const override;
   void setVec1f(std::string const & name, float value) const override;
   void setVec2f(std::string const & name, glm::vec2 const & value ) const override;
   void setVec3f(std::string const & name, glm::vec3 const & value ) const override;
   void setVec4f(std::string const & name, glm::vec4 const & value ) const override;
   void setMat2f(std::string const & name, glm::mat2 const & mat) const override;
   void setMat3f(std::string const & name, glm::mat3 const & mat) const override;
   void setMat4f(std::string const & name, glm::mat4 const & mat) const override;
