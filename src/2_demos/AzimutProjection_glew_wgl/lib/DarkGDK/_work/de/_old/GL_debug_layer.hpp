...
// ===========================================================================
inline char de_hexLowNibble( uint8_t byte )
// ===========================================================================
{
...
// ===========================================================================
inline char de_hexHighNibble( uint8_t byte )
// ===========================================================================
{
...
{
   std::ostringstream s;
   s << de_hexHighNibble( byte ) << de_hexLowNibble( byte );
   return s.str();
}
...
// ===========================================================================
{
   ...
   std::ostringstream s;
   s << de_hexByte( a ) << de_hexByte( b ) 
     << de_hexByte( g ) << de_hexByte( r );
   return s.str();
}

// ===========================================================================
inline std::string de_glGetErrorStr( u32 err )
// ===========================================================================
{
   if( err == 0 ) { return ""; }
...
inline void de_impl_glEnable( char const* file, int line, char const* func,
                                 u32 query )
{
   glEnable( query );
...
inline void de_impl_glDisable( char const* file, int line, char const* func,
                                 u32 query )
{
   glDisable( query );
...
inline s32 de_impl_glGetInteger( char const* file, int line, char const* func,
                                 u32 query )
{
   s32 value[4] { 0,0,0,0 };
...
inline f32 de_impl_glGetFloat( char const* file, int line, char const* func,
                                 u32 query )
{
   f32 value[4] { 0.f,0.f,0.f,0.f };
...
inline std::string de_impl_glGetString( char const* file, int line, char const* func,
                              u32 query )
{
...
inline u32 de_impl_glGenTexture( char const* file, int line, char const* func )
{
   u32 id = 0;
...
inline void de_impl_glActiveTexture( char const* file, int line, char const* func,
                                      u32 stage)
{
...
/*
inline void de_glBindTexture( u32 target, u32 tex )
{
   glBindTexture( target, tex );
   std::ostringstream s;
...
inline void de_glDeleteTexture( u32 tex )
{
   if ( tex == 0 )
   {
      return; // Nothing todo
...
inline void de_impl_glDrawArraysInstanced( char const* file, int line, char const* func,
                                  u32 mode, s32 first, s32 count , s32 instances )
{
...
inline std::string de_impl_glPrimitiveTypeStr( u32 mode )
{
   switch( mode )
   {
...
inline std::string de_impl_glIndexTypeStr( u32 mode )
{
   switch( mode )
   {
...
inline void de_impl_glDrawElements( char const* file, int line, char const* func,
                                  u32 mode, s32 count, u32 type, void const * indices   )
{
...
inline void de_impl_glBufferData( char const* file, int line, char const* func,
                                  u32 target, s32 byteCount, void* data, u32 bufferUsage )
{
//   if ( byteCount > std::numeric_limits< s32 >::max() )
//   {
//      std::cout << "[Error] "<<file<<"."<<func<<":"<<line<< " :: "
...
inline void de_impl_glVertexAttribPointer( char const* file, int line, char const* func,
                                  u32 index, s32 size, u32 type, u8 normalized, s32 stride, void const* data )
{
...
inline void de_impl_glBindFramebuffer( char const* file, int line, char const* func,
                              u32 target, u32 id, bool mustExist )
{
   if ( mustExist )
   {
      if (id < 1)
...
inline void de_impl_glFramebufferTexture2D( char const* file, int line, char const* func,
                              u32 target, u32 attachment, u32 textarget, u32 tex, s32 level )
{
...
/*
inline u32 de_glGenFramebuffer()
{
   u32 id = 0;
...
inline void de_glDeleteFramebuffer( u32 fbo )
{
   if ( fbo == 0 )
   {
      return; // Nothing todo
...
inline bool de_glCheckFramebufferStatus( u32 fbo_target )
{
...
inline void de_impl_glRenderbufferStorage( char const* file, int line, char const* func,
                              u32 target, u32 type, s32 w, s32 h )
{
...
inline void de_impl_glFramebufferRenderbuffer( char const* file, int line, char const* func,
                              u32 fbo, u32 attachment, u32 type, u32 tex )
{
...
inline void de_glViewport( s32 x, s32 y, s32 w, s32 h )
{
   glViewport( x, y, w, h );
   std::ostringstream s;
...
inline void de_glClearColor( f32 r, f32 g, f32 b, f32 a )
{
...
inline void de_glClearDepth( f32 d )
{
...
inline void de_glClearStencil( u8 stencil )
{
...
inline void de_glClear( u32 bits )
{
   glClear( bits );
   std::ostringstream s;
   s << "glClear("<<bits<<")";
...
inline void de_glBlendEquation( u32 mode )
{
...
inline void de_glBlendFunc( u32 sfactor, u32 dfactor )
{
