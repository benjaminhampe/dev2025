...
// ===========================================================================
{
   ...
   static Image* create( int32_t w, int32_t h, ColorFormat format = ColorFormat::RGBA8888 );
   static Ptr createPtr( int32_t w, int32_t h, ColorFormat format = ColorFormat::RGBA8888 );
   static SharedPtr createSharedPtr( int32_t w, int32_t h, ColorFormat format = ColorFormat::RGBA8888 );

   Image();
   Image( int32_t w, int32_t h, ColorFormat format = ColorFormat::RGBA8888 );
   Image( int32_t w, int32_t h, uint32_t fillColor, ColorFormat format );
   // ~Image() = default;
   ...
   void setFormat( ColorFormat colorFormat );
   ColorFormat const & getFormat() const { return m_ColorFormat; }
   ...
   uint32_t getChannelCount() const { return ColorUtil::getChannelCount( m_ColorFormat ); }
   std::string getFormatStr() const { return ColorUtil::getString( m_ColorFormat ); }
...
private:
   ...
   ColorFormat m_ColorFormat; // ColorBits A + R + G + B, if any
