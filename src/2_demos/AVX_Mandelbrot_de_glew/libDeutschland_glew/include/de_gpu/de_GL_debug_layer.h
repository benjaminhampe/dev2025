...
inline int32_t de_impl_glGetInteger( char const* file, int line, char const* func,
                                 uint32_t query )
{
...
inline float de_impl_glGetFloat( char const* file, int line, char const* func,
                                 uint32_t query )
{
...
inline void de_impl_glBufferData( char const* file, int line, char const* func,
                                  uint32_t target, int32_t byteCount, void* data, uint32_t bufferUsage )
{
