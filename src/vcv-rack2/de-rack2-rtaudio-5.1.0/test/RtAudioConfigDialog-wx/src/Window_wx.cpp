   ...
   , m_AudioConfigPanel( nullptr )
{
   ...
   m_AudioConfigPanel = new wxRtAudioConfigPanel( this );
   m_AudioPlayerPanel = new wxRtAudioPlayerPanel( this );
   m_enginePanel = new RtAudioEnginePanel_wx( this );
   m_enginePanel->setRtAudioConfigPanel( m_AudioConfigPanel );
   wxBoxSizer* v = new wxBoxSizer( wxVERTICAL );
   v->Add( m_AudioConfigPanel, wxSizerFlags().Expand() );
   v->Add( m_AudioPlayerPanel, wxSizerFlags().Expand() );
   v->Add( m_enginePanel, wxSizerFlags().Expand() );
   SetSizerAndFit( v );
}
