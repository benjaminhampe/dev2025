#ifndef DE_AUDIO_FILTER_IIR_LOWPASS3_2ND_ORDER_BIQUAD_HPP
#define DE_AUDIO_FILTER_IIR_LOWPASS3_2ND_ORDER_BIQUAD_HPP
...
public:
   ...
   void setVolume( int32_t volume ) { m_volume = std::clamp( volume, 0, 200 ); }
