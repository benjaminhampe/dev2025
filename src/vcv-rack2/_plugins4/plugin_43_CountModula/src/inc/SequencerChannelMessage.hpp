...
// utility macros 
	...
	#define isExpandableModule(x) x->model == modelSequencer8 || x->model == modelSequencerChannel8 || x->model == modelSequencerGates8 || x->model == modelSequencerTriggers8  || x->model == modelSequenceEncoder
	...
	#define isExpandableModule(x) x->model == modelSequencer16 || x->model == modelSequencerChannel16 || x->model == modelSequencerGates16 || x->model == modelSequencerTriggers16 || x->model == modelSequenceEncoder
#else
	#define isExpanderModule(x) x->model == modelSequencerChannel8 || x->model == modelSequencerGates8 || x->model == modelSequencerTriggers8 || x->model == modelSequencerChannel16 || x->model == modelSequencerGates16 || x->model == modelSequencerTriggers16
#endif
