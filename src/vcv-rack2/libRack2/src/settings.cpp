...
ModuleInfo* RACK_DLL_CALL getModuleInfo(const std::string& pluginSlug, const std::string& moduleSlug) {
...
bool RACK_DLL_CALL isModuleWhitelisted(const std::string& pluginSlug, const std::string& moduleSlug) {
...
void RACK_DLL_CALL resetCables() {
    cableColors = {
