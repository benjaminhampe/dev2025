...
If not all of the outputs are patched, then some outputs will be polyphonic. An unpatched output voice will come out the next connected jack. For some simple examples:
...
Another example: the triad on the 5th scale degree (the dominant) is a very strong and stable chord in a major key. But in some modes, like Locrian, the triad on the 5th is a diminished chord, and will have a much different role. Harmony will still think this is a strong chord.
