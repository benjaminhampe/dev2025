...
struct Transpose : Module {
	...
	Transpose()
  {
	...
	configInput(OCTAVE_SHIFT_1_INPUT,"Octave Shift");
	configInput(OCTAVE_SHIFT_1_CVINPUT,"Octave mod.");
	configInput(OCTAVE_SHIFT_2_INPUT,"Octave Shift");
	configInput(OCTAVE_SHIFT_2_CVINPUT,"Octave mod.");
	configInput(SEMITONE_SHIFT_1_INPUT,"Semitone Shift");
	configInput(SEMITONE_SHIFT_1_CVINPUT,"Semitone mod.");
	configInput(SEMITONE_SHIFT_2_INPUT,"Semitone Shift");
	configInput(SEMITONE_SHIFT_2_CVINPUT,"Semitone mod.");
	configInput(FINE_SHIFT_1_INPUT,"Fine Shift");
	configInput(FINE_SHIFT_1_CVINPUT,"Fine mod.");
	
	configOutput(OCTAVE_SHIFT_1_OUTPUT,"Octave Shift");
	configOutput(OCTAVE_SHIFT_2_OUTPUT,"Octave Shift");
	configOutput(SEMITONE_SHIFT_1_OUTPUT,"Semitone Shift");
	configOutput(SEMITONE_SHIFT_2_OUTPUT,"Semitone Shift");
	configOutput(FINE_SHIFT_1_OUTPUT,"Fine Shift");
...
TransposeWidget(Transpose *module){
   ...
   addInput(createInput<PJ301MSPort>(Vec(3, 2 + 45),  module, Transpose::OCTAVE_SHIFT_1_INPUT));
   addInput(createInput<PJ301MSPort>(Vec(3, 2 + 105), module, Transpose::OCTAVE_SHIFT_2_INPUT));
   addInput(createInput<PJ301MSPort>(Vec(3, 2 + 165), module, Transpose::SEMITONE_SHIFT_1_INPUT));
   addInput(createInput<PJ301MSPort>(Vec(3, 2 + 225), module, Transpose::SEMITONE_SHIFT_2_INPUT));
   addInput(createInput<PJ301MSPort>(Vec(3, 2 + 285), module, Transpose::FINE_SHIFT_1_INPUT));
  
   addInput(createInput<PJ301MSPort>(Vec(33, 15),  module, Transpose::OCTAVE_SHIFT_1_CVINPUT));
   addInput(createInput<PJ301MSPort>(Vec(33, 75),  module, Transpose::OCTAVE_SHIFT_2_CVINPUT));
   addInput(createInput<PJ301MSPort>(Vec(33, 135), module, Transpose::SEMITONE_SHIFT_1_CVINPUT));
   addInput(createInput<PJ301MSPort>(Vec(33, 195), module, Transpose::SEMITONE_SHIFT_2_CVINPUT));
   addInput(createInput<PJ301MSPort>(Vec(33, 255), module, Transpose::FINE_SHIFT_1_CVINPUT));
 
   addOutput(createOutput<PJ301MSPort>(Vec(33, 2 + 45), module, Transpose::OCTAVE_SHIFT_1_OUTPUT));
   addOutput(createOutput<PJ301MSPort>(Vec(33, 2 + 105),module, Transpose::OCTAVE_SHIFT_2_OUTPUT));
   addOutput(createOutput<PJ301MSPort>(Vec(33, 2 + 165),module, Transpose::SEMITONE_SHIFT_1_OUTPUT));
   addOutput(createOutput<PJ301MSPort>(Vec(33, 2 + 225),module, Transpose::SEMITONE_SHIFT_2_OUTPUT));
   addOutput(createOutput<PJ301MSPort>(Vec(33, 2 + 285),module, Transpose::FINE_SHIFT_1_OUTPUT));
