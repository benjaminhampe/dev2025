...
struct XF102 : SchemeModuleWidget {
    XF102(XF_102 *module) {
        ...
        addParam(createParamCentered<SubLightButton>(Vec(98, 102.5), module, XF_102::PARAM_LINK_1));
    }
    void render(NVGcontext *vg, SchemeCanvasWidget *canvas) override {
        drawBase(vg, "XF-102");
...
struct XF104 : SchemeModuleWidget {
    XF104(XF_104 *module) {
        ...
        addParam(createParamCentered<SubLightButton>(Vec(98, 102.5), module, XF_104::PARAM_LINK_1));
        addParam(createParamCentered<SubLightButton>(Vec(98, 278.5), module, XF_104::PARAM_LINK_2));
    }
    void render(NVGcontext *vg, SchemeCanvasWidget *canvas) override {
        drawBase(vg, "XF-104");
