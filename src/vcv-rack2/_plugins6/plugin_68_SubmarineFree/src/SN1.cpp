...
struct SN101 : SchemeModuleWidget {
    ...
    SN101(SN_1 *module) : SchemeModuleWidget() {
        ...
        addParam(lengthKnob);
        addParam(createParamCentered<SubLightButton>(Vec(20, 210), module, SN_1::PARAM_HARM_2));
        addParam(createParamCentered<SubLightButton>(Vec(20, 230), module, SN_1::PARAM_HARM_3));
        addParam(createParamCentered<SubLightButton>(Vec(20, 250), module, SN_1::PARAM_HARM_4));
        addParam(createParamCentered<SubLightButton>(Vec(20, 270), module, SN_1::PARAM_HARM_5));
        addParam(createParamCentered<SubLightButton>(Vec(20, 290), module, SN_1::PARAM_HARM_8));
