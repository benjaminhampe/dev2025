    ...
    struct IversonBase : Module
    {
        struct MidiOutput : midi::Output
        {
            ...
            void setCC (int cc, int val)
            {
                ...
                {
                    RK_DEBUG ("Iverson %s", e.what());
                    RK_DEBUG ("%d", this->channel);
                }
            }
            ...
            void resetNote (int note)
            {
                ...
                {
                    RK_DEBUG ("Iverson reset note %s", e.what());
                }
            }
            ...
            void setNote (int note, int velocity)
            {
                if (velocity != currentNotes[note])
                {
                    ...
                    {
                        RK_DEBUG ("Iverson setNote %s", e.what());
                    }
                }
                else if (velocity == -1)
                {
                    ...
                    {
                        RK_DEBUG ("Iverson setNote -1 %s", e.what());
                    }
                }
