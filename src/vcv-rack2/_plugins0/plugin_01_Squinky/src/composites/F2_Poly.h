...
private:
    ...
    void resetParamValueCache() {
        lastQCV[0] = float_4(-1.0f);
        lastQCV[1] = float_4(-1.0f);
        lastQCV[2] = float_4(-1.0f);
        lastQCV[3] = float_4(-1.0f);
        lastRCV[0] = float_4(-1.0f);
        lastRCV[1] = float_4(-1.0f);
        lastRCV[2] = float_4(-1.0f);
        lastRCV[3] = float_4(-1.0f);
        lastFcCV[0] = float_4(-1.0f);
        lastFcCV[1] = float_4(-1.0f);
        lastFcCV[2] = float_4(-1.0f);
        lastFcCV[3] = float_4(-1.0f);
        lastFcKnob = -1;
        lastFcTrim = -1;
        lastRKnob = -1;
        lastRTrim = -1;
