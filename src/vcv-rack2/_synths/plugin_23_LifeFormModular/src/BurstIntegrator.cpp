...
clockTime3 = powf(2.0, (inputs[CVIN_INPUT].getVoltage() + 2.0));	
    ...
    float bst32 = (gpulse1 && (stepCount1 % 1 == 0) ? 10.0f : (0.0f + rpulse) ? 10.0f : 0.0f);
    float bst64 = (gpulse2 && (stepCount2 % 1 == 0) ? 10.0f : (0.0f + rpulse) ? 10.0f : 0.0f);
    float bst128 =(gpulse3 && (stepCount3 % 1 == 0) ? 10.0f : (0.0f + rpulse) ? 10.0f : 0.0f);
