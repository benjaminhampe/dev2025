...
struct ClockDividerRateParamQuantity : rack::ParamQuantity
{
...
static ClockDividerRateParamQuantity* createClockDividerRateParamQuantity(rack::Module* module, int paramId, float minValue, float maxValue, float defaultValue, float displayMultiplier, bool snapEnabled, const std::string& name) {
...
struct ShapeParamQuantity : rack::ParamQuantity
{
    std::string getDisplayValueString() override
    {
...
static ShapeParamQuantity* createShapeParamQuantity(rack::Module* module, int paramId, float minValue, float maxValue, float defaultValue, float displayMultiplier, bool snapEnabled, const std::string& name) {
...
struct OctaveParamQuantity : rack::ParamQuantity {
    std::string getDisplayValueString() override {
        if (getValue() == -1.0f) {
            return "All";
        }
...
struct NoteParamQuantity : rack::ParamQuantity {
    std::string getDisplayValueString() override {
