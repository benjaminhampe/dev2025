#include "bidoo_plugin.hpp"
#include "dsp/digital.hpp"
#include "BidooComponents.hpp"

struct ENCOREExpander : BidooModule {
	enum ParamIds {
		FILL_PARAM,
	...
	void process(const ProcessArgs &args) override {
		if (leftExpander.module && (leftExpander.module->model == modelENCORE)) {
...
struct ENCOREExpanderWidget : BidooWidget {


	ENCOREExpanderWidget(ENCOREExpander *module) {
		setModule(module);
		prepareThemes(asset::plugin(pluginInstance, "res/ENCOREExpander.svg"));
		...
		for (int i = 0; i<8; i++) {
			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor, yInputAnchor+i*yOffset), module, ENCOREExpander::FILL_INPUT+i));
			addParam(createLightParam<SmallLEDLightBezel<RedGreenBlueLight>>(Vec(xControlAnchor, yControlAnchor+i*yOffset+yButtonOffset), module, ENCOREExpander::FILL_PARAM+i, ENCOREExpander::FILL_LIGHT+i*3));

			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor+xOffset, yInputAnchor+i*yOffset), module, ENCOREExpander::FORCE_INPUT+i));
			addParam(createLightParam<SmallLEDLightBezel<RedGreenBlueLight>>(Vec(xControlAnchor+xOffset, yControlAnchor+i*yOffset+yButtonOffset), module, ENCOREExpander::FORCE_PARAM+i, ENCOREExpander::FORCE_LIGHT+i*3));

			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor+2*xOffset, yInputAnchor+i*yOffset), module, ENCOREExpander::KILL_INPUT+i));
			addParam(createLightParam<SmallLEDLightBezel<RedGreenBlueLight>>(Vec(xControlAnchor+2*xOffset, yControlAnchor+i*yOffset+yButtonOffset), module, ENCOREExpander::KILL_PARAM+i, ENCOREExpander::KILL_LIGHT+i*3));

			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor+4*xOffset, yInputAnchor+i*yOffset - 7.0f), module, ENCOREExpander::DICE_INPUT+i));
			addParam(createParam<BidooSmallBlueKnob>(Vec(xControlAnchor+3*xOffset-7, yControlAnchor+i*yOffset+9), module, ENCOREExpander::DICE_PARAM+i));

			addParam(createLightParam<SmallLEDLightBezel<RedGreenBlueLight>>(Vec(xControlAnchor+5*xOffset, yControlAnchor+i*yOffset+yButtonOffset), module, ENCOREExpander::TRSPTYPE_PARAM+i, ENCOREExpander::TRSPTYPE_LIGHT+i*3));
			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor + 5.0f*xOffset, yInputAnchor + i*yOffset), module, ENCOREExpander::TRSP_INPUT+i));

			addParam(createParam<BidooBlueSnapTrimpot>(Vec(xControlAnchor+6.0f*xOffset, yControlAnchor+i*yOffset+11.0f), module, ENCOREExpander::ROTSHIFT_PARAM+i));
			addParam(createParam<BidooBlueSnapTrimpot>(Vec(xControlAnchor+7.2f*xOffset, yControlAnchor+i*yOffset+11.0f), module, ENCOREExpander::ROTLEN_PARAM+i));

			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor + 8.5*xOffset, yInputAnchor + i*yOffset-7.0f), module, ENCOREExpander::ROTLEFT_INPUT+i));
			addInput(createInput<TinyPJ301MPort>(Vec(xInputAnchor + 9.5*xOffset, yInputAnchor+ i*yOffset-7.0f), module, ENCOREExpander::ROTRIGHT_INPUT+i));
...
Model *modelENCOREExpander = createModel<ENCOREExpander, ENCOREExpanderWidget>("ENCORE-Expander");
