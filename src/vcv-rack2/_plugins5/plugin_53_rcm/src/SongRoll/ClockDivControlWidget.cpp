...
void ClockDivControlWidget::draw(const DrawArgs& args)
{
  ...
  // void ClockDivControlWidget::onMouseDown(event::MouseDown& e) {
void ClockDivControlWidget::onButton(const rack::event::Button& e)
{
