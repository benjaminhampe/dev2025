...
PatternData::PatternAction::PatternAction(std::string name, int64_t moduleId, int patternId, PatternData& patternData) : patternId(patternId) {
  this->name = name;
...
json_t *PatternData::dataToJson() const {
...
void PatternData::dataFromJson(json_t *patternsJ) {
  dirty = true;
  reset();
