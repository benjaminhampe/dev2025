...
namespace rack_themer {
    ...
    public:
        ...
        rack::math::Vec findNamed (const std::string& name, const rack::math::Vec defaultValue) {
            return findNamed (name).value_or (defaultValue);
        }
