...
struct Switch81 : Module, SwitchBase {
	...
	Switch81() {
		...
		getInputInfo(STEP_CV_1_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_2_INPUT, "Step 2 Weight CV");
		getInputInfo(STEP_CV_2_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_3_INPUT, "Step 3 Weight CV");
		getInputInfo(STEP_CV_3_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_4_INPUT, "Step 4 Weight CV");
		getInputInfo(STEP_CV_4_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_5_INPUT, "Step 5 Weight CV");
		getInputInfo(STEP_CV_5_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_6_INPUT, "Step 6 Weight CV");
		getInputInfo(STEP_CV_6_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_7_INPUT, "Step 7 Weight CV");
		getInputInfo(STEP_CV_7_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_8_INPUT, "Step 8 Weight CV");
		getInputInfo(STEP_CV_8_INPUT)->description = "Expects a 0-10V signal";
		configInput(STEP_CV_9_INPUT, "Step 9 Weight CV");
		getInputInfo(STEP_CV_9_INPUT)->description = "Expects a 0-10V signal";
