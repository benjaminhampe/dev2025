...
struct Contextus : SanguineModule {
	...
	Contextus() {
		...
		for (int channel = 0; channel < PORT_MAX_CHANNELS; ++channel) {
            memset((void*)&oscillators[channel], 0, sizeof(renaissance::MacroOscillator));
            memset((void*)&quantizers[channel], 0, sizeof(renaissance::Quantizer));
            memset((void*)&envelopes[channel], 0, sizeof(renaissance::Envelope));
            memset((void*)&jitterSources[channel], 0, sizeof(renaissance::VcoJitterSource));
            memset((void*)&waveShapers[channel], 0, sizeof(renaissance::SignatureWaveshaper));
