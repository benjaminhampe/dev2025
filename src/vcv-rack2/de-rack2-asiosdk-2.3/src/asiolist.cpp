...
// ******************************************************************
static LONG
findDrvPath (char *clsidstr,char *dllpath,int dllpathsize)
{
...
static LPASIODRVSTRUCT
newDrvStruct (HKEY hkey,char *keyname,int drvID,LPASIODRVSTRUCT lpdrv)
{
    HKEY	hksub;
    char	databuf[256];
...
static void
deleteDrvStruct (LPASIODRVSTRUCT lpdrv)
{
    IASIO* iasio;
    if (lpdrv != 0) {
...
static LPASIODRVSTRUCT
getDrvStruct (int drvID,LPASIODRVSTRUCT lpdrv)
{
    while (lpdrv) {
...
LONG
AsioDriverList::asioOpenDriver (int drvID,LPVOID *asiodrv)
{
...
IASIO*
AsioDriverList::getIASIO (int drvID)
{
    LPASIODRVSTRUCT	lpdrv = 0;
    //IASIO*          iasio;
...
LONG
AsioDriverList::asioGetDriverName (int drvID,char *drvname,int drvnamesize)
{
    LPASIODRVSTRUCT			lpdrv = 0;
...
LONG
AsioDriverList::asioGetDriverPath (int drvID,char *dllpath,int dllpathsize)
{
    LPASIODRVSTRUCT			lpdrv = 0;
...
LONG
AsioDriverList::asioGetDriverCLSID (int drvID,CLSID *clsid)
{
    LPASIODRVSTRUCT			lpdrv = 0;
