...
RotatingClockDivider2Widget::RotatingClockDivider2Widget(
  ...
  addInput(createInput<RCJackSmallLight>(
      Vec(31.23, 109), module, RotatingClockDivider2Module::ROTATE_INPUT));
  addInput(createInput<RCJackSmallLight>(
      Vec(31.23, 65), module, RotatingClockDivider2Module::TOP_INPUT));
  addInput(createInput<RCJackSmallLight>(
      Vec(3.8, 87), module, RotatingClockDivider2Module::RESET_INPUT));

  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 158), module, RotatingClockDivider2Module::DIV_OUTPUT + 0));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 179), module, RotatingClockDivider2Module::DIV_OUTPUT + 1));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 200), module, RotatingClockDivider2Module::DIV_OUTPUT + 2));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 221), module, RotatingClockDivider2Module::DIV_OUTPUT + 3));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 242), module, RotatingClockDivider2Module::DIV_OUTPUT + 4));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 263), module, RotatingClockDivider2Module::DIV_OUTPUT + 5));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 284), module, RotatingClockDivider2Module::DIV_OUTPUT + 6));
  addOutput(createOutput<RCJackSmallDark>(
      Vec(10.23, 305), module, RotatingClockDivider2Module::DIV_OUTPUT + 7));
