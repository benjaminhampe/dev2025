...
#elif JUCE_WINDOWS
#include <juce_video/native/juce_win32_CameraDevice.h>
#elif JUCE_IOS
#include <juce_video/native/juce_ios_CameraDevice.h>
#elif JUCE_ANDROID
#include <juce_video/native/juce_android_CameraDevice.h>
#endif
