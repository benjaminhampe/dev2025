...
#include <juce_gui_basics/buttons/juce_ButtonAccessibilityHandler.hpp>
#include <juce_gui_basics/widgets/juce_ToolbarItemComponent_ItemDragAndDropOverlayComponent.h>
namespace juce
{
