...
#pragma once
//#include <juce_dsp/containers/juce_AudioBlock.h> // SampleTypeHelpers
#include <juce_dsp/processors/juce_ProcessContext.h> // ProcessSpec
...
public:
    ...
    */
    ...
    {
        jassert (isPositiveAndBelow (newFrequencyHz, static_cast<SampleType> (sampleRate * 0.5)));

        cutoffFrequency = newFrequencyHz;
        update();
    }
