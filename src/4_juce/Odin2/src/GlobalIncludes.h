...
#define MODULE_DISABLED_ALPHA 0.75f
...
#define INTERPOLATION_QUALITY_LOW Graphics_lowResamplingQuality
#define INTERPOLATION_QUALITY_HIGH Graphics_highResamplingQuality
