...
MyAudioProcessor::MyAudioProcessor()
    ...
    , parameters(*this, nullptr, "PARAMS", AudioProcessorValueTreeState::ParameterLayout{}) // empty layout
{
    AudioProcessorValueTreeState::ParameterLayout layout;

    layout.add(std::make_unique<AudioParameterFloat>("param1", "Param 1", 0.0f, 1.0f, 0.5f));
    layout.add(std::make_unique<AudioParameterFloat>("param2", "Param 2", 0.0f, 1.0f, 0.5f));
    // ... add all your parameters here

    parameters.replaceState(AudioProcessorValueTreeState(layout).copyState());
}
...
AudioProcessorValueTreeState::ParameterLayout {
    ...
    createParam("param2"),
    // ...
    createParam("param258"),
}

auto layout1 = AudioProcessorValueTreeState::ParameterLayout {
    createParam("param1"),
    // ...
    createParam("param128"),
};

auto layout2 = AudioProcessorValueTreeState::ParameterLayout {
    createParam("param129"),
    // ...
    createParam("param258"),
};

auto fullLayout = AudioProcessorValueTreeState::ParameterLayout {};
fullLayout.add(std::move(layout1));
fullLayout.add(std::move(layout2));
