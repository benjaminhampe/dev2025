...
private:
    static juce::Font createFont()
    {
        auto typeface = juce::Typeface::createSystemTypefaceFor(
            BinaryData::KnockoutFlyweight_otf,
            BinaryData::KnockoutFlyweight_otfSize);

        if (typeface != nullptr)
            return juce::Font(typeface);   // old API

        return juce::Font(14.0f);          // fallback
    }

    static juce::Font createMonoFont()
    {
        auto typeface = juce::Typeface::createSystemTypefaceFor(
            BinaryData::JetBrainsMonoLight_otf,
            BinaryData::JetBrainsMonoLight_otfSize);
