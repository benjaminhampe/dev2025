...
public:
   ...
   void initialise(const String& commandLine) override
   {
      ...
      // <dwmapi.h> enum DWMWINDOWATTRIBUTE:
      // Use 20 for Windows 10 1903+ and Windows 11
      // Use 19 for Windows 10 1809
      #ifndef DWMWA_USE_IMMERSIVE_DARK_MODE
      #define DWMWA_USE_IMMERSIVE_DARK_MODE 20  // or 19 on older builds
      #endif
