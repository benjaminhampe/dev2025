   ...
   , m_editorWindow( nullptr )
{
   ...
   m_btnEnabled = ShellCommon::createEnableButton( skin, this );
   m_btnExtraMore = ShellCommon::createMoreButton( skin, this );
   m_btnEditor = ShellCommon::createEditorButton( skin, this );
   m_btnLoadPreset = ShellCommon::createUpdateButton( skin, this );
   m_btnSavePreset = ShellCommon::createSaveButton( skin, this );
