#pragma once
#include <de/audio/buffer/FloatBuffer.h>
...
public:
   ...
   join( FloatBuffer & dst ) const
   {
      ...
      for ( size_t i = 0; i < m_chunks.size(); ++i )
      {
         ...
         if ( !chunk ) continue;
         auto writtenSamples
             = chunk->writeSamples( 0, pDst, chunk->getFrameCount(), dstChannels, false );
         pDst += writtenSamples;
      }

      DE_DEBUG("JOINED ", dst.toString() )
      return true;
   }
