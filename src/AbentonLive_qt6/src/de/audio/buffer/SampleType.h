...
namespace audio {
    ...
    // ===========================================================================
    {
        enum EApi
        {
            AUTO_SELECT = 0, WIN_WASAPI, WIN_ASIO, WIN_DSOUND, LINUX_ALSA, LINUX_PULSE, LINUX_OSS, WAV_WRITER, EApiCount,
        };
    ...
    */
    ...
    // ============================================================================
    {
        ...
        {
            std::ostringstream o;
            o << ST_toString( m_SampleType ) << "*" << m_ChannelCount << "*" << int(0.1f * int(0.01f*m_SampleRate)) << "kHz";
            //<< "*" << m_FrameCount << "|Duration:" << dbSecondsToString( getDuration() );
            return o.str();
        }
