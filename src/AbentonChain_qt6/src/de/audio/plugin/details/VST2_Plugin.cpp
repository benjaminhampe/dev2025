...
const DspTrack* VST2_Plugin::getTrack() const { return _d->m_track; }

DspTrack* VST2_Plugin::getTrack() { return _d->m_track; }

void VST2_Plugin::setTrack(DspTrack* track) { _d->m_track = track; }
