...
bool load_sound_wav_f32(Sound & sound, const std::string & uri )
{
    ...
    sound.m_fileInfo.channelCount = fmt.num_channels;
    sound.m_fileInfo.frameCount = nFrames;
    sound.m_fileInfo.sampleRate = fmt.sample_rate;
    ...
    if (fmt.audio_format == 1)
    {
        ...
        {
            sound.m_fileInfo.sampleType = FileInfo::ST_S16; // | FileInfo::ST_Interleaved;
        ...
        {
            sound.m_fileInfo.sampleType = FileInfo::ST_S24; // | AudioFile::ST_Interleaved;
        ...
        {
            sound.m_fileInfo.sampleType = FileInfo::ST_S32; // | AudioFile::ST_Interleaved;
    ...
    {
        sound.m_fileInfo.sampleType = FileInfo::ST_F32; // | AudioFile::ST_Interleaved;
