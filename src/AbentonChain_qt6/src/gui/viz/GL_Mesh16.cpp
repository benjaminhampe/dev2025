...
void GL_Mesh16::upload( bool bForceUpload, bool bNeedIndexUpload )
{
...
void GL_Mesh16::initVAO( bool bUseIndices )
{
    ...
    if ( bNeedBindVAO )
    {
        ...
        glEnableVertexAttribArray( 0 );
    #if 0
        glVertexAttribPointer( 0, 4, GL_SHORT, GL_TRUE, sizeof(GL_Mesh16_Vertex), reinterpret_cast<void*>(0) );
    #else
        glVertexAttribPointer( 0, 4, GL_HALF_FLOAT, GL_FALSE, sizeof(GL_Mesh16_Vertex), reinterpret_cast<void*>(0) );
    #endif
