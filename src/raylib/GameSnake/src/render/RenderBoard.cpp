...
{
    Image TopBorder = LoadImage("media/GameSnake/BorderTop.png");
    Image Ground1 = LoadImage("media/GameSnake/Ground1.png");
    Image Ground2 = LoadImage("media/GameSnake/Ground2.png");
