...
{
    Image AppleImage = LoadImage("media/GameSnake/Apple.png");
    Image FrogImage = LoadImage("media/GameSnake/Frog.png");
    Image MouseImage = LoadImage("media/GameSnake/Mouse.png");
