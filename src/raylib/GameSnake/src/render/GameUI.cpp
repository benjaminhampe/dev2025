...
GameUI::GameUI()
{
    Background_ = LoadTexture("media/GameSnake/GameBackground.png");
    MenuPanel_ = LoadTexture("media/GameSnake/MenuPanel.png");
    GameOverLablel_ = LoadTexture("media/GameSnake/GameOver.png");
    YouWonLabel_ = LoadTexture("media/GameSnake/YouWon.png");
    ScoreBar_ = LoadTexture("media/GameSnake/ScoreBar.png");
    StartButton_ = new Button("media/GameSnake/StartButton.png", UI::START_BUTTON::Position_, UI::START_BUTTON::Scale_);
    ExitButton_ = new Button("media/GameSnake/ExitButton.png", UI::EXIT_BUTTON::Position_, UI::EXIT_BUTTON::Scale_);
    RestartButton_ = new Button("media/GameSnake/RestartButton.png", UI::RESTART_BUTTON::Position_, UI::RESTART_BUTTON::Scale_);
    StartScore_ = 0;
    Score_ = nullptr;
}
