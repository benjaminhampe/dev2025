...
set PATH=C:\sdk\llvm-mingw-20260210-ucrt-x86_64\bin;%PATH%
set PATH=C:\sdk\llvm-mingw-20260210-ucrt-x86_64\python\bin;%PATH%
set PATH=C:\sdk\llvm-mingw-20260210-ucrt-x86_64\python\include;%PATH%
set PATH=C:\sdk\llvm-mingw-20260210-ucrt-x86_64\python\lib;%PATH%
